...
class TestCURDataQuery(unittest.TestCase):
    """CURDataQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CURDataQuery:
        """Test CURDataQuery
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CURDataQuery`
        """
        model = CURDataQuery()
        if include_optional:
            return CURDataQuery(
