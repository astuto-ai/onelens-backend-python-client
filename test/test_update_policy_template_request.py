...
class TestUpdatePolicyTemplateRequest(unittest.TestCase):
    """UpdatePolicyTemplateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePolicyTemplateRequest:
        """Test UpdatePolicyTemplateRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UpdatePolicyTemplateRequest`
        """
    ...
    def testUpdatePolicyTemplateRequest(self):
        """Test UpdatePolicyTemplateRequest"""
