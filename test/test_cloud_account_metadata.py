...
class TestCloudAccountMetadata(unittest.TestCase):
    """CloudAccountMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CloudAccountMetadata:
        """Test CloudAccountMetadata
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CloudAccountMetadata`
        """
        model = CloudAccountMetadata()
        if include_optional:
    ...
    def testCloudAccountMetadata(self):
        """Test CloudAccountMetadata"""
