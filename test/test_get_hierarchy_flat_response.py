...
class TestGetHierarchyFlatResponse(unittest.TestCase):
    """GetHierarchyFlatResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetHierarchyFlatResponse:
        """Test GetHierarchyFlatResponse
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetHierarchyFlatResponse`
        """
        model = GetHierarchyFlatResponse()
        if include_optional:
            return GetHierarchyFlatResponse(
                data = [
    ...
    def testGetHierarchyFlatResponse(self):
        """Test GetHierarchyFlatResponse"""
