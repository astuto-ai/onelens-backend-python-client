...
class TestTenantFeature(unittest.TestCase):
    """TenantFeature unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TenantFeature:
        """Test TenantFeature
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TenantFeature`
        """
        model = TenantFeature()
        if include_optional:
