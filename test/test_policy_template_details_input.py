...
class TestPolicyTemplateDetailsInput(unittest.TestCase):
    """PolicyTemplateDetailsInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyTemplateDetailsInput:
        """Test PolicyTemplateDetailsInput
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PolicyTemplateDetailsInput`
        """
        model = PolicyTemplateDetailsInput()
        if include_optional:
            return PolicyTemplateDetailsInput(
                inputs = [
                    ''
                    ],
    ...
    def testPolicyTemplateDetailsInput(self):
        """Test PolicyTemplateDetailsInput"""
