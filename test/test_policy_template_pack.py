...
class TestPolicyTemplatePack(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PolicyTemplatePack:
        """Test PolicyTemplatePack
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyTemplatePack`
        """
        model = PolicyTemplatePack()
        if include_optional:
            return PolicyTemplatePack(
                alias = '',
    ...
    def testPolicyTemplatePack(self):
        """Test PolicyTemplatePack"""
