...
class TestTenantPolicyWithPolicyDisplayAlias(unittest.TestCase):
    """TenantPolicyWithPolicyDisplayAlias unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TenantPolicyWithPolicyDisplayAlias:
        """Test TenantPolicyWithPolicyDisplayAlias
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TenantPolicyWithPolicyDisplayAlias`
        """
        model = TenantPolicyWithPolicyDisplayAlias()
        if include_optional:
            return TenantPolicyWithPolicyDisplayAlias(
                parent_ptp_id = '',
                title = '',
                alias = '',
                description = '',
                    ...
                    metrics_details = [
                        onelens_backend_client.models.metrics_chart_config.MetricsChartConfig(
                            ...
                            look_back_period = onelens_backend_client.models.metrics_look_back_period.MetricsLookBackPeriod(
                                ...
                                value = null, ), 
                            filter = [
                                onelens_backend_client.models.metric_chart_filters.MetricChartFilters(
                                    key = '', 
                                    value_from = '', 
                                    value = null, 
                                    operator = 'equals', )
    ...
    def testTenantPolicyWithPolicyDisplayAlias(self):
        """Test TenantPolicyWithPolicyDisplayAlias"""
