...
class TestOnelensModelsServiceInterfacesTenantDataMetricsServiceFilterCriteria(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OnelensModelsServiceInterfacesTenantDataMetricsServiceFilterCriteria:
