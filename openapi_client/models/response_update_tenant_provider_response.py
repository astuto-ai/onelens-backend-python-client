...
class ResponseUpdateTenantProviderResponse(BaseModel):
    """
    ResponseUpdateTenantProviderResponse
    """ # noqa: E501
    data: UpdateTenantProviderResponse
    message: Message
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": UpdateTenantProviderResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
