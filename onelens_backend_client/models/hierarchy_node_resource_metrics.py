...
class HierarchyNodeResourceMetrics(BaseModel):
    ...
    """ # noqa: E501
    total: StrictInt = Field(description="The total count of the resource.")
    unique: Optional[StrictInt] = None
    conflicting: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["total", "unique", "conflicting"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if conflicting (nullable) is None
        # and model_fields_set contains the field
        if self.conflicting is None and "conflicting" in self.model_fields_set:
            _dict['conflicting'] = None
