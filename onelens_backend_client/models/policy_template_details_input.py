...
class PolicyTemplateDetailsInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["inputs", "config_schema", "primary_violation_attributes_schema", "secondary_violation_attributes_schema", "rule_type", "rule_definition", "default_policy_config", "metrics_details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metrics_details": [MetricsChartConfigInput.from_dict(_item) for _item in obj["metrics_details"]] if obj.get("metrics_details") is not None else None
        })
        return _obj
