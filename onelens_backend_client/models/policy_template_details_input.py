...
class PolicyTemplateDetailsInput(BaseModel):
    ...
    metrics_details: Optional[List[MetricsChartConfigInput]] = None
    __properties: ClassVar[List[str]] = [
        "inputs",
        "config_schema",
        "primary_violation_attributes_schema",
        "secondary_violation_attributes_schema",
        "rule_type",
        "rule_definition",
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.primary_violation_attributes_schema is None
            and "primary_violation_attributes_schema" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.secondary_violation_attributes_schema is None
            and "secondary_violation_attributes_schema" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.rule_definition_hash is None
            and "rule_definition_hash" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.default_policy_config is None
            and "default_policy_config" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.default_policy_config_hash is None
            and "default_policy_config_hash" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "primary_violation_attributes_schema": obj.get(
                    "primary_violation_attributes_schema"
                ),
                "secondary_violation_attributes_schema": obj.get(
                    "secondary_violation_attributes_schema"
                ),
                ...
                "metrics_details": [
                    MetricsChartConfigInput.from_dict(_item)
                    for _item in obj["metrics_details"]
                ]
                if obj.get("metrics_details") is not None
                else None,
            }
        )
        return _obj
