...
class CreateAuth0UserRequest(BaseModel):
    ...
    connection: Auth0UserConnection = Field(description="The connection of the user in Auth0.")
    __properties: ClassVar[List[str]] = ["email", "password", "email_verified", "app_metadata", "connection"]
