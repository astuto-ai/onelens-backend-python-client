...
class GetTenantProvidersResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.tenant_provider_filter_data is None
            and "tenant_provider_filter_data" in self.model_fields_set
        ):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "tenant_provider_filter_data": [
                    TenantProvider.from_dict(_item)
                    for _item in obj["tenant_provider_filter_data"]
                ]
                if obj.get("tenant_provider_filter_data") is not None
                else None,
