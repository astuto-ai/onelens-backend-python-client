...
class GetHierarchyNodeMetricsRequest(BaseModel):
    ...
    node_ids: List[StrictStr] = Field(description="The ids of the nodes.")
    breakdown: Optional[StrictBool] = Field(default=False, description="Whether to breakdown the metrics.")
    __properties: ClassVar[List[str]] = ["tenant_id", "node_ids", "breakdown"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "breakdown": obj.get("breakdown") if obj.get("breakdown") is not None else False
        })
        return _obj
