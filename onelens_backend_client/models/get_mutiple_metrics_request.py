...
class GetMutipleMetricsRequest(BaseModel):
    ...
    """ # noqa: E501
    queries: List[MetricsQueryInput] = Field(description="The list of queries.")
    tenant_id: StrictStr = Field(description="The id of the tenant.")
    __properties: ClassVar[List[str]] = ["queries", "tenant_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "queries": [MetricsQueryInput.from_dict(_item) for _item in obj["queries"]] if obj.get("queries") is not None else None,
