...
class RecommendationEngineResponse(BaseModel):
    ...
    """ # noqa: E501
    recommendations: List[RecommendationEngine] = Field(description="Recommendations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "recommendations": [RecommendationEngine.from_dict(_item) for _item in obj["recommendations"]] if obj.get("recommendations") is not None else None
        })
        return _obj
