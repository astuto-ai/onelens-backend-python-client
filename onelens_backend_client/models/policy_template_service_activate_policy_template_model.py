...
class PolicyTemplateServiceActivatePolicyTemplateModel(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": ActivatePolicyTemplateRequest.from_dict(obj["request"]) if obj.get("request") is not None else None
        })
        return _obj
