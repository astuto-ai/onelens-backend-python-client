...
class GetHierarchyFlatResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[HierarchyNodeEntityWithDetails] = Field(description="The data of the hierarchy.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [HierarchyNodeEntityWithDetails.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
