...
class GetTenantTicketsResponse(BaseModel):
    ...
    tenant_tickets: List[TenantTicket] = Field(
        description="List of tickets of the tenant"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.tenant_tickets:
            for _item in self.tenant_tickets:
                if _item:
                    _items.append(_item.to_dict())
            _dict["tenant_tickets"] = _items
        return _dict
        ...
        _obj = cls.model_validate(
            {
                ...
                "tenant_tickets": [
                    TenantTicket.from_dict(_item) for _item in obj["tenant_tickets"]
                ]
                if obj.get("tenant_tickets") is not None
                else None,
            }
        )
        return _obj
