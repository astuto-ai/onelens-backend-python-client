...
class GetResourceHierarchyMappingByOlIdRequest(BaseModel):
    ...
    """ # noqa: E501
    resource_catalog_ol_id: StrictStr = Field(description="Resource Catalog Ol Id")
    tenant_id: StrictStr = Field(description="The id of the tenant.")
    __properties: ClassVar[List[str]] = ["resource_catalog_ol_id", "tenant_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resource_catalog_ol_id": obj.get("resource_catalog_ol_id"),
