...
class GetPolicyTicketsExportToResponseType(BaseModel):
    ...
    url: StrictStr = Field(description="downloadable url")
    extenstion: StrictStr = Field(description="The file extension of the file")
    __properties: ClassVar[List[str]] = ["url", "extenstion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"url": obj.get("url"), "extenstion": obj.get("extenstion")}
        )
        return _obj
