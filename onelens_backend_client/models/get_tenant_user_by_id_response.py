...
class GetTenantUserByIDResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["profile_pic_url", "last_login", "status", "first_name", "middle_name", "last_name", "email", "mobile_country_code", "mobile_number", "persona", "role", "job_title", "manager", "city", "state", "country", "display_language", "preferred_currency", "timezone", "display_date_format", "display_time_format", "sources", "ol_user_id", "id"]
