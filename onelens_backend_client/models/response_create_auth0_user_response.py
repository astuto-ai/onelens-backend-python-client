...
class ResponseCreateAuth0UserResponse(BaseModel):
    """
    ResponseCreateAuth0UserResponse
    """ # noqa: E501
    data: CreateAuth0UserResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": CreateAuth0UserResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
