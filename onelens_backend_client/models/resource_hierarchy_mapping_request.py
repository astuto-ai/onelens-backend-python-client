...
class ResourceHierarchyMappingRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["tenant_id", "leaf_nodes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of leaf_nodes
        if self.leaf_nodes:
            _dict["leaf_nodes"] = self.leaf_nodes.to_dict()
        return _dict
        ...
        _obj = cls.model_validate(
            {
                ...
                "leaf_nodes": LeafNodes.from_dict(obj["leaf_nodes"])
                if obj.get("leaf_nodes") is not None
                else None,
            }
        )
        return _obj
