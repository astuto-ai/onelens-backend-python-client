...
class OnelensModelsServiceInterfacesUtilitiesDataRetrieverServiceTimeDimension(
    ...
    compare_date_range: Optional[
        List[
            OnelensModelsServiceInterfacesUtilitiesDataRetrieverServiceTimeDimensionCompareDateRangeInner
        ]
    ] = Field(default=None, alias="compareDateRange")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.compare_date_range is None
            and "compare_date_range" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "compareDateRange": [
                    OnelensModelsServiceInterfacesUtilitiesDataRetrieverServiceTimeDimensionCompareDateRangeInner.from_dict(
                        _item
                    )
                    for _item in obj["compareDateRange"]
                ]
                if obj.get("compareDateRange") is not None
                else None,
