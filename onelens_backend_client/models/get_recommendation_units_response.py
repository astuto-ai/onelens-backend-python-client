...
class GetRecommendationUnitsResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in recommendation_units (list)
        _items = []
        if self.recommendation_units:
            for _item in self.recommendation_units:
                if _item:
        ...
        _obj = cls.model_validate(
            {
                "recommendation_units": [
                    RecommendationUnitWithActionType.from_dict(_item)
                    for _item in obj["recommendation_units"]
                ]
                if obj.get("recommendation_units") is not None
                else None,
