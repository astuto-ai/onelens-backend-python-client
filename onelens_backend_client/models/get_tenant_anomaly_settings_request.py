...
class GetTenantAnomalySettingsRequest(BaseModel):
    ...
    filters: Optional[TenantAnomalySettingFilters] = Field(default=None, description="Filters to apply to the tenant anomalies.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": TenantAnomalySettingFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None,
