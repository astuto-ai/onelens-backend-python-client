...
class GetAllNaviraFullLogResponse(BaseModel):
    ...
    navira_logs: List[NaviraFullLogResponse] = Field(description="List of Navira Logs.")
    __properties: ClassVar[List[str]] = ["pagination", "navira_logs"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in navira_logs (list)
        _items = []
        if self.navira_logs:
            for _item in self.navira_logs:
                if _item:
                    _items.append(_item.to_dict())
            _dict["navira_logs"] = _items
        return _dict
        ...
        _obj = cls.model_validate(
            {
                ...
                "navira_logs": [
                    NaviraFullLogResponse.from_dict(_item)
                    for _item in obj["navira_logs"]
                ]
                if obj.get("navira_logs") is not None
                else None,
            }
        )
        return _obj
