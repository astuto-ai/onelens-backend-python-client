...
class GetPolicyTicketStatsGroupBy(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.field_display_name is None
            and "field_display_name" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "field_details": [
                    GetPolicyTicketStatsSubGroupBy.from_dict(_item)
                    for _item in obj["field_details"]
                ]
                if obj.get("field_details") is not None
                else None,
