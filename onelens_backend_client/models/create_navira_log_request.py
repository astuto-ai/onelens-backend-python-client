...
class CreateNaviraLogRequest(BaseModel):
    ...
    user_id: StrictStr = Field(description="User ID (UUID4) associated with the log.")
    request: Optional[Dict[str, Any]] = None
    status: Optional[GenerationStatus] = Field(default=None, description="The status of the log.")
    response: Optional[Dict[str, Any]] = None
    extradata: Optional[Dict[str, Any]] = None
    feedback: Optional[FeedbackModel] = None
    __properties: ClassVar[List[str]] = ["tenant_id", "user_id", "request", "status", "response", "extradata", "feedback"]
