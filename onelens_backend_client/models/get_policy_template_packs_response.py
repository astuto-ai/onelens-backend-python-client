...
class GetPolicyTemplatePacksResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policy_template_packs": [PolicyTemplatePack.from_dict(_item) for _item in obj["policy_template_packs"]] if obj.get("policy_template_packs") is not None else None
        })
        return _obj
