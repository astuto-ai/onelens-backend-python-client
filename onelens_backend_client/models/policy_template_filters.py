...
class PolicyTemplateFilters(BaseModel):
    ...
    parent_ptp_ids: Optional[List[StrictStr]] = Field(
        default=None, description="Filter by parent policy template pack id."
    )
    ...
    services: Optional[List[ActionTypeFiltersServicesInner]] = Field(
