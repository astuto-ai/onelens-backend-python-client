...
class TenantPolicyTicketDetailsMixin(BaseModel):
    ...
    policy_template_id: StrictStr = Field(
    ...
    policy_config_version: StrictInt = Field(
    ...
    potential_cost_saving: Union[StrictFloat, StrictInt] = Field(
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.policy_config_hash is None
            and "policy_config_hash" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.preferred_recommendation_id is None
            and "preferred_recommendation_id" in self.model_fields_set
        ):
