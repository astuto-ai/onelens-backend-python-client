...
class ResourceCatalogWithCost(BaseModel):
    ...
    previous_month_cost: Optional[Union[StrictFloat, StrictInt]] = None
    current_month_cost: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if previous_month_cost (nullable) is None
        # and model_fields_set contains the field
        if (
            self.previous_month_cost is None
            and "previous_month_cost" in self.model_fields_set
        ):
            _dict["previous_month_cost"] = None

        # set to None if current_month_cost (nullable) is None
        # and model_fields_set contains the field
        if (
            self.current_month_cost is None
            and "current_month_cost" in self.model_fields_set
        ):
            _dict["current_month_cost"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "previous_month_cost": obj.get("previous_month_cost"),
                "current_month_cost": obj.get("current_month_cost"),
            }
        )
        return _obj
