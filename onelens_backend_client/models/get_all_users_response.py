...
class GetAllUsersResponse(BaseModel):
    ...
    auth0_id: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "state": obj.get("state"),
                "details": UserCatalogDetails.from_dict(obj["details"])
                if obj.get("details") is not None
                else None,
                "users": [
                    GetUserByIDResponse.from_dict(_item) for _item in obj["users"]
                ]
