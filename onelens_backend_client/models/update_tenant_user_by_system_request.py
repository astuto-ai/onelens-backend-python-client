...
class UpdateTenantUserBySystemRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["last_login", "first_name", "middle_name", "last_name", "mobile_country_code", "mobile_number", "persona", "job_title", "manager", "city", "state", "country", "display_language", "preferred_currency", "timezone", "display_date_format", "display_time_format", "ol_user_id", "tenant_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.mobile_country_code is None and "mobile_country_code" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.display_language is None and "display_language" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.display_date_format is None and "display_date_format" in self.model_fields_set:
            _dict['display_date_format'] = None

        # set to None if display_time_format (nullable) is None
        # and model_fields_set contains the field
        if self.display_time_format is None and "display_time_format" in self.model_fields_set:
