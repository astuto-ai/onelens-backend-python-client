...
class ResourceRelationshipResponse(BaseModel):
    ...
    relationship_type: StrictStr = Field(description="The relationship type")
    direction: StrictStr = Field(description="The relationship direction")
    resource: ResourceCatalog = Field(description="The resource details.")
    __properties: ClassVar[List[str]] = ["relationship_type", "direction", "resource"]
