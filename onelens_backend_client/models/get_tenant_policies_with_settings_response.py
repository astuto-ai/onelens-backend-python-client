...
class GetTenantPoliciesWithSettingsResponse(BaseModel):
    ...
    policies_data: List[TenantPolicyWithSetting] = Field(description="The list of policies with settings.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policies_data": [TenantPolicyWithSetting.from_dict(_item) for _item in obj["policies_data"]] if obj.get("policies_data") is not None else None
        })
        return _obj
