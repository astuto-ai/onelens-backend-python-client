...
class CreateRecommenadtionUnitPullResponse(BaseModel):
    ...
    pr_link: Annotated[str, Field(min_length=1, strict=True, max_length=2083)] = Field(
        description="The recommendation unit pull request link."
    )
    __properties: ClassVar[List[str]] = ["pr_link"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"pr_link": obj.get("pr_link")})
        return _obj
