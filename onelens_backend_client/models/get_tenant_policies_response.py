...
class GetTenantPoliciesResponse(BaseModel):
    ...
    policies: List[TenantPolicy] = Field(description="List of tenant policies.")
    __properties: ClassVar[List[str]] = ["pagination", "policies"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "policies": [TenantPolicy.from_dict(_item) for _item in obj["policies"]]
