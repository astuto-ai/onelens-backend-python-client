...
class RecommendationUnitWithActionType(BaseModel):
    ...
    target_attribute: Optional[StrictStr] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.action_type_alias is None
            and "action_type_alias" in self.model_fields_set
        ):
        ...
        # set to None if target_attribute (nullable) is None
        # and model_fields_set contains the field
        if (
            self.target_attribute is None
            and "target_attribute" in self.model_fields_set
        ):
            _dict["target_attribute"] = None

        # set to None if action_type_service (nullable) is None
        # and model_fields_set contains the field
        if (
            self.action_type_service is None
            and "action_type_service" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.action_type_title is None
            and "action_type_title" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.action_type_subtitle is None
            and "action_type_subtitle" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.action_type_description is None
            and "action_type_description" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "query_details": RecommendationQueryDetails.from_dict(
                    obj["query_details"]
                )
                if obj.get("query_details") is not None
                else None,
                "target_attribute": obj.get("target_attribute"),
