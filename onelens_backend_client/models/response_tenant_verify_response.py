...
class ResponseTenantVerifyResponse(BaseModel):
    """
    ResponseTenantVerifyResponse
    """ # noqa: E501
    data: TenantVerifyResponse
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": TenantVerifyResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
