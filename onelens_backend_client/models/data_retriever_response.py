...
class DataRetrieverResponse(BaseModel):
    ...
    last_refresh_time: Optional[StrictStr] = Field(
        default=None, alias="lastRefreshTime"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            ...
            and "last_refresh_time" in self.model_fields_set
        ):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "query": DataRetrieverQuery.from_dict(obj["query"])
