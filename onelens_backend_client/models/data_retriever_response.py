...
class DataRetrieverResponse(BaseModel):
    ...
    db_type: Optional[StrictStr] = Field(default=None, alias="dbType")
    ext_db_type: Optional[StrictStr] = Field(default=None, alias="extDbType")
    external: Optional[StrictBool] = None
    slow_query: Optional[StrictBool] = Field(default=None, alias="slowQuery")
    total: Optional[StrictInt] = None
    error: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["query", "data", "annotation", "lastRefreshTime", "dataSource", "dbType", "extDbType", "external", "slowQuery", "total", "error"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if last_refresh_time (nullable) is None
        # and model_fields_set contains the field
        if self.last_refresh_time is None and "last_refresh_time" in self.model_fields_set:
            _dict['lastRefreshTime'] = None
        ...
        # set to None if ext_db_type (nullable) is None
        # and model_fields_set contains the field
        if self.ext_db_type is None and "ext_db_type" in self.model_fields_set:
            _dict['extDbType'] = None
        ...
        # set to None if slow_query (nullable) is None
        # and model_fields_set contains the field
        if self.slow_query is None and "slow_query" in self.model_fields_set:
            _dict['slowQuery'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "extDbType": obj.get("extDbType"),
            "external": obj.get("external"),
            "slowQuery": obj.get("slowQuery"),
            "total": obj.get("total"),
            "error": obj.get("error")
        })
        return _obj
