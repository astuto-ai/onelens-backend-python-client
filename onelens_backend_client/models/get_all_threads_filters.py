...
class GetAllThreadsFilters(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["user_ids", "agent_types", "name"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if agent_types (nullable) is None
        # and model_fields_set contains the field
        if self.agent_types is None and "agent_types" in self.model_fields_set:
            _dict["agent_types"] = None
