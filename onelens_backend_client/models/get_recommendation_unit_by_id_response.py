...
class GetRecommendationUnitByIdResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of recommendation_unit
        if self.recommendation_unit:
            _dict["recommendation_unit"] = self.recommendation_unit.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "recommendation_unit": RecommendationUnit.from_dict(
                    obj["recommendation_unit"]
                )
                if obj.get("recommendation_unit") is not None
                else None
            }
        )
        return _obj
