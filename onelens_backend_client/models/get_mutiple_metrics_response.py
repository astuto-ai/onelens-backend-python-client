...
class GetMutipleMetricsResponse(BaseModel):
    ...
    """ # noqa: E501
    metrics: List[GetMutipleMetricsResponseMixin]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metrics": [GetMutipleMetricsResponseMixin.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None
        })
        return _obj
