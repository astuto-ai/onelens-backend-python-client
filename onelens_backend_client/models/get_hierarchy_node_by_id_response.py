...
class GetHierarchyNodeByIdResponse(BaseModel):
    ...
    path: List[HierarchyNodePathItem] = Field(description="The path of the node from root.")
    parent: Optional[HierarchyNodeParentItem] = None
    resources_metrics: Optional[HierarchyNodeResourceMetrics] = None
    __properties: ClassVar[List[str]] = ["id", "name", "category", "resource_filters", "resource_filter_expression", "is_shared", "attribution_details", "state", "sql_filter", "path", "parent", "resources_metrics"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of resources_metrics
        if self.resources_metrics:
            _dict['resources_metrics'] = self.resources_metrics.to_dict()
        ...
        # set to None if resources_metrics (nullable) is None
        # and model_fields_set contains the field
        if self.resources_metrics is None and "resources_metrics" in self.model_fields_set:
            _dict['resources_metrics'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_shared": obj.get("is_shared") if obj.get("is_shared") is not None else False,
            ...
            "path": [HierarchyNodePathItem.from_dict(_item) for _item in obj["path"]] if obj.get("path") is not None else None,
            "parent": HierarchyNodeParentItem.from_dict(obj["parent"]) if obj.get("parent") is not None else None,
            "resources_metrics": HierarchyNodeResourceMetrics.from_dict(obj["resources_metrics"]) if obj.get("resources_metrics") is not None else None
        })
        return _obj
