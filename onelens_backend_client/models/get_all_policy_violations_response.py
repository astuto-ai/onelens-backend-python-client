...
class GetAllPolicyViolationsResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pagination", "policy_violations"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.policy_violations:
            ...
            _dict["policy_violations"] = _items
        return _dict
        ...
        _obj = cls.model_validate(
            {
                ...
                "policy_violations": [
                    GetSinglePolicyViolationsResponse.from_dict(_item)
                    for _item in obj["policy_violations"]
                ]
                if obj.get("policy_violations") is not None
                else None,
            }
        )
        return _obj
