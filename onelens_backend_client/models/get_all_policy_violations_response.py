...
class GetAllPolicyViolationsResponse(BaseModel):
    ...
    policy_violations: List[GetSinglePolicyViolationsResponse] = Field(description="List of policy violations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policy_violations": [GetSinglePolicyViolationsResponse.from_dict(_item) for _item in obj["policy_violations"]] if obj.get("policy_violations") is not None else None
        })
        return _obj
