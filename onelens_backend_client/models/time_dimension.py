...
class TimeDimension(BaseModel):
    ...
    compare_date_range: Optional[List[TimeDimensionCompareDateRangeInner]] = Field(default=None, alias="compareDateRange")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "compareDateRange": [TimeDimensionCompareDateRangeInner.from_dict(_item) for _item in obj["compareDateRange"]] if obj.get("compareDateRange") is not None else None,
