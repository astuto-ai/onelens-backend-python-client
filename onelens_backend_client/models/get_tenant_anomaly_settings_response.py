...
class GetTenantAnomalySettingsResponse(BaseModel):
    ...
    anomaly_settings: List[TenantAnomalySettings] = Field(description="List of tenant anomalies.")
    __properties: ClassVar[List[str]] = ["pagination", "anomaly_settings"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in anomaly_settings (list)
        _items = []
        if self.anomaly_settings:
            for _item in self.anomaly_settings:
                if _item:
                    _items.append(_item.to_dict())
            _dict['anomaly_settings'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "anomaly_settings": [TenantAnomalySettings.from_dict(_item) for _item in obj["anomaly_settings"]] if obj.get("anomaly_settings") is not None else None
        })
        return _obj
