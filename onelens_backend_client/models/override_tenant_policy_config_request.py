...
class OverrideTenantPolicyConfigRequest(BaseModel):
    ...
    """ # noqa: E501
    config_overrides: Dict[str, Any] = Field(description="The config overrides for the tenant policy.")
    tenant_id: StrictStr = Field(description="The id of the tenant.")
    tenant_policy_id: StrictStr = Field(description="The id of the tenant policy.")
    __properties: ClassVar[List[str]] = ["config_overrides", "tenant_id", "tenant_policy_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tenant_policy_id": obj.get("tenant_policy_id")
        })
        return _obj
