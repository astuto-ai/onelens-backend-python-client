...
class NaviraFullLogResponse(BaseModel):
    ...
    request: Dict[str, Any] = Field(description="The query data represented as a JSON object.")
    created_at: Optional[datetime] = None
    response: Dict[str, Any] = Field(description="The response represented as a JSON object.")
