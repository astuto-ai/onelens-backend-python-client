...
class BulkUpdateTenantTicketsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: BulkUpdateTenantTicketsRequestMixin = Field(description="Updated tickets data")
    message: Optional[StrictStr] = None
    error: Optional[List[BulkUpdateTenantTicketsErrorMixin]] = Field(default=None, description="Error of the response")
    status_code: StrictInt = Field(description="Status code of the response")
    __properties: ClassVar[List[str]] = ["data", "message", "error", "status_code"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": BulkUpdateTenantTicketsRequestMixin.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "message": obj.get("message"),
            "error": [BulkUpdateTenantTicketsErrorMixin.from_dict(_item) for _item in obj["error"]] if obj.get("error") is not None else None,
