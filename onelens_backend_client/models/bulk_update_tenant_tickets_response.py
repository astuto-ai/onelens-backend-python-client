...
class BulkUpdateTenantTicketsResponse(BaseModel):
    ...
    error: Optional[List[BulkUpdateTenantTicketsErrorMixin]] = Field(
        default=None, description="Error of the response"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": BulkUpdateTenantTicketsRequestMixin.from_dict(obj["data"])
                if obj.get("data") is not None
                else None,
                "message": obj.get("message"),
                "error": [
                    BulkUpdateTenantTicketsErrorMixin.from_dict(_item)
