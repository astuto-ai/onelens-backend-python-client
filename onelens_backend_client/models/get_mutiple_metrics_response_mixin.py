...
class GetMutipleMetricsResponseMixin(BaseModel):
    ...
    metrics: List[OnelensModelsServiceInterfacesTenantDataMetricsServiceMetric]
    unit: StrictStr
    __properties: ClassVar[List[str]] = ["query", "metrics", "unit"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "metrics": [
                    OnelensModelsServiceInterfacesTenantDataMetricsServiceMetric.from_dict(
                        _item
                    )
