...
class GetAllThreadsRequest(BaseModel):
    ...
    filters: Optional[GetAllThreadsFilters] = None
    __properties: ClassVar[List[str]] = ["pagination", "tenant_id", "filters"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "filters": GetAllThreadsFilters.from_dict(obj["filters"])
