...
class DataRetrieverQuery(BaseModel):
    ...
    ] = Field(default=None, alias="timeDimensions")
        ...
        _obj = cls.model_validate(
            {
                ...
                "filters": [QueryFilters.from_dict(_item) for _item in obj["filters"]]
                if obj.get("filters") is not None
                else None,
                "timeDimensions": [
                    OnelensModelsServiceInterfacesUtilitiesDataRetrieverServiceTimeDimension.from_dict(
                        _item
                    )
                    for _item in obj["timeDimensions"]
                ]
                if obj.get("timeDimensions") is not None
                else None,
