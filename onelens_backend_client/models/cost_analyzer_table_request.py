...
class CostAnalyzerTableRequest(BaseModel):
    ...
    filters: List[Dict[str, Any]] = Field(
        description="Filters for the cost analyzer table"
    )
    group_by: List[StrictStr] = Field(
        description="Group by for the cost analyzer table"
    )
    __properties: ClassVar[List[str]] = ["pagination", "filters", "group_by"]
