...
class GetPolicyTicketsByPolicyIdResponse(BaseModel):
    ...
    policy_tickets: List[GetSinglePolicyTicketByPolicyIdResponse] = Field(
        description="List of policy_tickets"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "policy_tickets": [
                    GetSinglePolicyTicketByPolicyIdResponse.from_dict(_item)
                    for _item in obj["policy_tickets"]
                ]
                if obj.get("policy_tickets") is not None
                else None,
            }
        )
        return _obj
