...
class TenantPolicyForPolicyWithSetting(BaseModel):
    ...
    services: List[TenantPolicyForPolicyWithSettingServicesInner] = Field(description="The list of services display names associated the policy template.")
    ...
    state: TenantPolicySystemState = Field(description="The state of the tenant policy.")
    __properties: ClassVar[List[str]] = ["parent_ptp_id", "title", "alias", "description", "services", "execution_type", "details", "description2", "resource_type", "recommendation_details", "policy_template_id", "category", "provider", "id", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "services": [TenantPolicyForPolicyWithSettingServicesInner.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None,
