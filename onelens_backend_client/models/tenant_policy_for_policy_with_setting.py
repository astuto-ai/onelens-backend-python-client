...
class TenantPolicyForPolicyWithSetting(BaseModel):
    ...
    services: List[TenantPolicyForPolicyWithSettingServicesInner] = Field(
    ...
    is_new: Optional[StrictBool] = Field(
        default=False, description="Flag to indicate if the policy is new."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "services": [
                    TenantPolicyForPolicyWithSettingServicesInner.from_dict(_item)
