...
class CreateActionTypePullRequest(BaseModel):
    ...
    description: StrictStr = Field(description="The description of the pull request.")
    ...
    alias: StrictStr = Field(description="The unique identifier alias of the action type.")
    commit_message: StrictStr = Field(description="Action type change commit message")
    __properties: ClassVar[List[str]] = ["title", "description", "source_branch", "branch_name", "alias", "commit_message"]
