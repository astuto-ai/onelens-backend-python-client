...
class UpdatePolicyTemplateRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["force_update", "title", "description", "services", "execution_type", "details", "description2", "resource_type", "recommendation_details", "requirements", "id"]
