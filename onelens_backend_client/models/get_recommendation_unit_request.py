...
class GetRecommendationUnitRequest(BaseModel):
    ...
    filters: Optional[RecommendationUnitFilters] = Field(default=None, description="Filters to apply to the Recommendation Unit.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": RecommendationUnitFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
