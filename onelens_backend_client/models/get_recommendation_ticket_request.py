...
class GetRecommendationTicketRequest(BaseModel):
    ...
    ticket_id: StrictStr = Field(description="Ticket ID")
    tenant_id: StrictStr = Field(description="The unique identifier of the tenant")
    __properties: ClassVar[List[str]] = ["ticket_id", "tenant_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"ticket_id": obj.get("ticket_id"), "tenant_id": obj.get("tenant_id")}
        )
        return _obj
