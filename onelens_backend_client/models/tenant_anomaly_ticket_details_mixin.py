...
class TenantAnomalyTicketDetailsMixin(BaseModel):
    ...
    anomalies: List[AnomalyRcaIdsMixin] = Field(
        description="List of anomaly ids and rca ids."
    )
    total_cost_impact: Union[StrictFloat, StrictInt] = Field(
        description="Total cost incurred due to the anomaly."
    )
    rca_hash: StrictStr = Field(
        description="The hash of the RCA associated with the anomaly."
    )
    deviation: Deviation
    duration: Union[StrictFloat, StrictInt] = Field(
        description="The duration of the anomaly."
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "anomalies": [
                    AnomalyRcaIdsMixin.from_dict(_item) for _item in obj["anomalies"]
                ]
                if obj.get("anomalies") is not None
                else None,
                "total_cost_impact": obj.get("total_cost_impact"),
                "rca_hash": obj.get("rca_hash"),
                "deviation": Deviation.from_dict(obj["deviation"])
