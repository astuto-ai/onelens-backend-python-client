...
class GetLeafNodesResponse(BaseModel):
    ...
    """ # noqa: E501
    nodes: List[HierarchyNodeEntityDTO] = Field(description="List of leaf nodes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": [HierarchyNodeEntityDTO.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None
        })
        return _obj
