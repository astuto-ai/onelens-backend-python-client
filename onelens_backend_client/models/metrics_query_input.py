...
class MetricsQueryInput(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": [OnelensModelsServiceInterfacesTenantDataMetricsServiceFilterCriteriaInput.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None,
            "time_filter": OnelensModelsServiceInterfacesTenantDataMetricsServiceTimeDimensionInput.from_dict(obj["time_filter"]) if obj.get("time_filter") is not None else None,
