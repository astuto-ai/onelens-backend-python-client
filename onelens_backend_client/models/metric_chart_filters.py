...
class MetricChartFilters(BaseModel):
    ...
    key: StrictStr = Field(description="Dynamic key-value pairs for metric filters")
    value_from: Optional[StrictStr] = None
    value: Optional[Value2] = None
    operator: Optional[OnelensModelsServiceInterfacesPoliciesCommonsOperator] = None
    __properties: ClassVar[List[str]] = ["key", "value_from", "value", "operator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "key": obj.get("key"),
                "value_from": obj.get("value_from"),
                "value": Value2.from_dict(obj["value"])
