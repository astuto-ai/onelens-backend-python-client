...
class NaviraLogFeedbackUpdateApiRequest(BaseModel):
    ...
    feedback: FeedbackModel = Field(description="Feedback associated with the log.")
    navira_log_id: StrictStr = Field(description="The id of the navira log.")
    __properties: ClassVar[List[str]] = ["feedback", "navira_log_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "feedback": FeedbackModel.from_dict(obj["feedback"])
