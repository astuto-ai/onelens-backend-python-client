...
class DataRetrieverQueryInput(BaseModel):
    ...
    time_dimensions: Optional[List[OnelensModelsServiceInterfacesUtilitiesDataRetrieverServiceTimeDimension]] = Field(default=None, alias="timeDimensions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timeDimensions": [OnelensModelsServiceInterfacesUtilitiesDataRetrieverServiceTimeDimension.from_dict(_item) for _item in obj["timeDimensions"]] if obj.get("timeDimensions") is not None else None,
