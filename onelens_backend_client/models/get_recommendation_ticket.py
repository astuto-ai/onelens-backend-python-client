...
class GetRecommendationTicket(BaseModel):
    ...
    data: List[RecommendationTicket] = Field(description="Data")
    __properties: ClassVar[List[str]] = ["recommendation_unit_id", "potential_saving", "priority", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [RecommendationTicket.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
