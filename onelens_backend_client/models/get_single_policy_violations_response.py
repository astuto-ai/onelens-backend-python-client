...
class GetSinglePolicyViolationsResponse(BaseModel):
    ...
    policy_services: List[StrictStr] = Field(description="List of services")
    ...
    resources: StrictInt = Field(description="Number of resources affected by the policy violation")
    __properties: ClassVar[List[str]] = ["policy_id", "policy_title", "policy_labels", "policy_services", "potential_savings", "resources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "policy_services": obj.get("policy_services"),
