...
class ResourceTypes(BaseModel):
    ...
    aws_url_template: StrictStr
    relationship_config: List[RelationshipConfigItem]
    __properties: ClassVar[List[str]] = ["resource_type", "resource_table", "select_columns", "aws_url_template", "relationship_config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "aws_url_template": obj.get("aws_url_template"),
