...
class CreateSavedViewAPIRequest(BaseModel):
    ...
    name: Annotated[str, Field(strict=True, max_length=30)] = Field(
        description="Name of the saved view"
    )
    page: Annotated[str, Field(min_length=3, strict=True, max_length=30)] = Field(
        description="Page of the saved view"
    )
    payload: SavedViewItemPayloadInput = Field(description="Payload of the saved view")
    __properties: ClassVar[List[str]] = ["name", "page", "payload"]
        ...
        _obj = cls.model_validate(
            {
                "name": obj.get("name"),
                "page": obj.get("page"),
                "payload": SavedViewItemPayloadInput.from_dict(obj["payload"])
