...
class GetTenantPolicySettingsRequest(BaseModel):
    ...
    filters: Optional[TenantPolicySettingsFilters] = Field(default=None, description="Filters to apply to the tenant policy settings.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": TenantPolicySettingsFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None,
