...
class DataRetrieverQueryOutput(BaseModel):
    ...
    time_dimensions: Optional[List[TimeDimensionOutput]] = Field(default=None, alias="timeDimensions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timeDimensions": [TimeDimensionOutput.from_dict(_item) for _item in obj["timeDimensions"]] if obj.get("timeDimensions") is not None else None,
