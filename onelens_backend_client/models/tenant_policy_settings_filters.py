...
class TenantPolicySettingsFilters(BaseModel):
    ...
    """ # noqa: E501
    states: Optional[List[TenantPolicyState]] = Field(default=None, description="Filter by state. Default is ACTIVE.")
    policy_ids: Optional[List[StrictStr]] = Field(default=None, description="Filter by tenant policy id.")
