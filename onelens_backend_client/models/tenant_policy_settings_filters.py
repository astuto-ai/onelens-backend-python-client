...
class TenantPolicySettingsFilters(BaseModel):
    ...
    states: Optional[List[TenantPolicyState]] = Field(
        default=None, description="Filter by state. Default is ACTIVE."
    )
    policy_ids: Optional[List[StrictStr]] = Field(
        default=None, description="Filter by tenant policy id."
    )
    __properties: ClassVar[List[str]] = ["states", "policy_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"states": obj.get("states"), "policy_ids": obj.get("policy_ids")}
        )
        return _obj
