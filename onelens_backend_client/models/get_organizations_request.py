...
class GetOrganizationsRequest(BaseModel):
    ...
    """ # noqa: E501
    filters: Optional[OrganizationFilters] = Field(default=None, description="Filters to apply to the policy templates.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": OrganizationFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
