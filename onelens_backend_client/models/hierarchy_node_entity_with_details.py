...
class HierarchyNodeEntityWithDetails(BaseModel):
    ...
    path: List[HierarchyNodePathItem] = Field(
        description="The path of the node from root."
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.resource_filters is None
            and "resource_filters" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.resources_metrics is None
            and "resources_metrics" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "path": [
                    HierarchyNodePathItem.from_dict(_item) for _item in obj["path"]
                ]
                if obj.get("path") is not None
                else None,
                "parent": HierarchyNodeParentItem.from_dict(obj["parent"])
                if obj.get("parent") is not None
                else None,
                "resources_metrics": HierarchyNodeResourceMetrics.from_dict(
                    obj["resources_metrics"]
                )
                if obj.get("resources_metrics") is not None
                else None,
            }
        )
        return _obj
