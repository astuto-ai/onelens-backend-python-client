...
class GetAllThreadsResponse(BaseModel):
    ...
    threads: List[Thread] = Field(description="List of threads for the tenant")
    __properties: ClassVar[List[str]] = ["pagination", "threads"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "threads": [Thread.from_dict(_item) for _item in obj["threads"]]
