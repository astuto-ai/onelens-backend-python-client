...
class GetPolicyTicketsExportAPIRequest(BaseModel):
    ...
    selected_fields: Optional[List[TicketsSelectedField]] = None
    file_extension: Optional[ExportFileType] = Field(
        default=None, description="export file type"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.selected_fields:
            for _item in self.selected_fields:
                if _item:
                    _items.append(_item.to_dict())
        ...
        # set to None if selected_fields (nullable) is None
        # and model_fields_set contains the field
        if self.selected_fields is None and "selected_fields" in self.model_fields_set:
            _dict["selected_fields"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "sort_criteria": SortCriteria.from_dict(obj["sort_criteria"])
                if obj.get("sort_criteria") is not None
                else None,
                "selected_fields": [
                    TicketsSelectedField.from_dict(_item)
                    for _item in obj["selected_fields"]
                ]
