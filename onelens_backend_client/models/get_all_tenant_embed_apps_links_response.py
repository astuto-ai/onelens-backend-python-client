...
class GetAllTenantEmbedAppsLinksResponse(BaseModel):
    ...
    links: List[TenantEmbedAppsLinksWithUser] = Field(description="List of links")
    __properties: ClassVar[List[str]] = ["pagination", "links"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "links": [
                    TenantEmbedAppsLinksWithUser.from_dict(_item)
