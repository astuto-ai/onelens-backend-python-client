...
class QueryDetailsDerivedVariables(BaseModel):
    ...
    value_type: StrictStr = Field(description="Value Type")
    source_key: StrictStr = Field(description="Source Key")
    __properties: ClassVar[List[str]] = ["key", "value_type", "source_key"]
