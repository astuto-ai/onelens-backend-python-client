...
class GetActionTypeResponse(BaseModel):
    ...
    action_types: List[ActionType] = Field(description="Action Types")
    pagination: PaginationFields = Field(description="Pagination fields")
    __properties: ClassVar[List[str]] = ["action_types", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "action_types": [
                    ActionType.from_dict(_item) for _item in obj["action_types"]
                ]
                if obj.get("action_types") is not None
                else None,
