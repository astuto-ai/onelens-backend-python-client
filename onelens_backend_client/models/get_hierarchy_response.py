...
class GetHierarchyResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier of the hierarchy.")
    data: Dict[str, Any] = Field(description="The data of the hierarchy.")
    version: StrictInt = Field(description="The version of the hierarchy.")
    ...
    __properties: ClassVar[List[str]] = ["id", "data", "version", "state", "type"]
