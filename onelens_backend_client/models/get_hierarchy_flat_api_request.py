...
class GetHierarchyFlatAPIRequest(BaseModel):
    ...
    """ # noqa: E501
    filters: Optional[GetHierarchyFlatFilters] = Field(default=None, description="Filters for flat hierarchy nodes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": GetHierarchyFlatFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
