...
class GetResourceCatalogCountStatsResponse(BaseModel):
    ...
    metric_value: StrictInt = Field(description="Fetched metric value")
    __properties: ClassVar[List[str]] = ["metric_value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"metric_value": obj.get("metric_value")})
        return _obj
