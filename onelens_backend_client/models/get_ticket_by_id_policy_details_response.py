...
class GetTicketByIdPolicyDetailsResponse(BaseModel):
    ...
    recommendation_units: List[StrictStr] = Field(
        description="List of recommendation units"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.hierarchy_details is None
            and "hierarchy_details" in self.model_fields_set
        ):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "tenant_ticket": TenantTicketWithTicketAlias.from_dict(
                    obj["tenant_ticket"]
                )
                if obj.get("tenant_ticket") is not None
                else None,
                "policy_details": TenantPolicyWithPolicyDisplayAlias.from_dict(
                    obj["policy_details"]
                )
                if obj.get("policy_details") is not None
                else None,
                ...
                "violation_metrics_details": [
                    ViolationMetricsDetails.from_dict(_item)
                    for _item in obj["violation_metrics_details"]
                ]
                if obj.get("violation_metrics_details") is not None
                else None,
