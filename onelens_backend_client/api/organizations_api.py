...
class OrganizationsApi:
    ...
    def disable_organization(
        ...
        _param = self._disable_organization_serialize(
    ...
    @validate_call
    def disable_organization_with_http_info(
        self,
        organization_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def disable_organization_without_preload_content(
        self,
        organization_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _disable_organization_serialize(
        self,
        organization_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="PUT",
            resource_path="/v1/org/{organization_id}/disable",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def enable_organization(
        ...
        _param = self._enable_organization_serialize(
            organization_id=organization_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def enable_organization_with_http_info(
        self,
        organization_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def enable_organization_without_preload_content(
        self,
        organization_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _enable_organization_serialize(
        self,
        organization_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="PUT",
            resource_path="/v1/org/{organization_id}/enable",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_organization(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "GetOrganizationByIDResponse",
            "422": "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
    ...
    def get_organization_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetOrganizationByIDResponse]:
        """Get Organization
    ...
    def _get_organization_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/v1/org/{organization_id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_organizations(
        ...
        :param get_organizations_request: (required)
