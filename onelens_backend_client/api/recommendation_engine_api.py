...
class RecommendationEngineApi:
    ...
    def get_recommendation_unit_by_id(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ResponseGetRecommendationUnitByIdResponse",
    ...
    def get_recommendation_unit_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseGetRecommendationUnitByIdResponse]:
        """Get Recommendation Unit By Id
    ...
    def _get_recommendation_unit_by_id_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/v1/recommendation_engine/{recommendation_id}",
    ...
    def get_recommendation_units(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ResponseGetRecommendationUnitsResponse",
            "422": "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
    ...
    def get_recommendation_units_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseGetRecommendationUnitsResponse]:
        """Get Recommendation Units
    ...
    def _get_recommendation_units_serialize(
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v1/recommendation_engine/units",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_recommendations(
        self,
        recommendation_engine_api_request: RecommendationEngineAPIRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param recommendation_engine_api_request: (required)
        :type recommendation_engine_api_request: RecommendationEngineAPIRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_recommendations_serialize(
            recommendation_engine_api_request=recommendation_engine_api_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ResponseRecommendationEngineResponse",
            "422": "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
    ...
    def get_recommendations_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseRecommendationEngineResponse]:
        """Get Recommendations
    ...
    def _get_recommendations_serialize(
        self,
        recommendation_engine_api_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if recommendation_engine_api_request is not None:
            _body_params = recommendation_engine_api_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/v1/recommendation_engine",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
