...
class TenantsResourceCatalogApi:
    ...
    def create_root_node(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ResponseResourceHierarchyMappingResponse",
    ...
    def create_root_node_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseResourceHierarchyMappingResponse]:
        """Create Root Node
    ...
    def _create_root_node_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/tenants/{tenant_id}/resource_mapping',
    ...
    def _create_root_node_0_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/resource_mapping',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
