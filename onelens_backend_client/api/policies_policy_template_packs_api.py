...
class PoliciesPolicyTemplatePacksApi:
    ...
    def create_policy_template_pack(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ResponseCreatePolicyTemplatePackResponse",
    ...
    def create_policy_template_pack_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseCreatePolicyTemplatePackResponse]:
        """Create Policy Template Pack
    ...
    def get_policy_template_pack(
        ...
        :param policy_template_pack_id: (required)
        :type policy_template_pack_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ResponseGetPolicyTemplatePackByIdResponse",
            "422": "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
    ...
    def get_policy_template_pack_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseGetPolicyTemplatePackByIdResponse]:
        """Get Policy Template Pack
    ...
    def _get_policy_template_pack_serialize(
        ...
        # process the path parameters
        if policy_template_pack_id is not None:
            _path_params["policy_template_pack_id"] = policy_template_pack_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
    ...
    def get_policy_template_packs(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ResponseGetPolicyTemplatePacksResponse",
            "422": "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
    ...
    def get_policy_template_packs_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseGetPolicyTemplatePacksResponse]:
        """Get Policy Template Packs
