...
class RecommendationEngineServiceApi:
    ...
    def query_executor(
        ...
        :param query_executor_request: (required)
        :type query_executor_request: QueryExecutorRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._query_executor_serialize(
            query_executor_request=query_executor_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def query_executor_with_http_info(
        self,
        query_executor_request: QueryExecutorRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def query_executor_without_preload_content(
        self,
        query_executor_request: QueryExecutorRequest,
        _request_timeout: Union[
            None,
    ...
    def _query_executor_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if query_executor_request is not None:
            _body_params = query_executor_request
