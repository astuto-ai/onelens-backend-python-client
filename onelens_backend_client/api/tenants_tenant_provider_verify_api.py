...
class TenantsTenantProviderVerifyApi:
    ...
    def verify_tenant(
        ...
        tenant_verify_request: TenantVerifyRequest,
        ...
        :param tenant_verify_request: (required)
        :type tenant_verify_request: TenantVerifyRequest
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ResponseTenantVerifyResponse",
    ...
    def verify_tenant_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseTenantVerifyResponse]:
        """Verify Tenant
    ...
    def _verify_tenant_serialize(
        ...
        if tenant_verify_request is not None:
            _body_params = tenant_verify_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/tenants/{tenant_id}/providers/{tenant_provider_id}/verify',
    ...
    def verify_tenant_0(
        ...
        _param = self._verify_tenant_0_serialize(
            tenant_provider_id=tenant_provider_id,
            tenant_verify_request=tenant_verify_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def verify_tenant_0_with_http_info(
        self,
        tenant_provider_id: StrictStr,
        tenant_verify_request: TenantVerifyRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def verify_tenant_0_without_preload_content(
        self,
        tenant_provider_id: StrictStr,
        tenant_verify_request: TenantVerifyRequest,
        _request_timeout: Union[
    ...
    def _verify_tenant_0_serialize(
        self,
        tenant_provider_id,
        tenant_verify_request,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/providers/{tenant_provider_id}/verify',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def verify_tenant_cur_bucket(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ResponseTenantVerifyCurBucketResponse",
            '422': "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    def verify_tenant_cur_bucket_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseTenantVerifyCurBucketResponse]:
        """Verify Tenant Cur Bucket
    ...
    @validate_call
    def verify_tenant_cur_bucket_0(
        self,
        tenant_verify_cur_bucket_request: TenantVerifyCurBucketRequest,
        _request_timeout: Union[
            None,
        ...
        _param = self._verify_tenant_cur_bucket_0_serialize(
            tenant_verify_cur_bucket_request=tenant_verify_cur_bucket_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def verify_tenant_cur_bucket_0_with_http_info(
        self,
        tenant_verify_cur_bucket_request: TenantVerifyCurBucketRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def verify_tenant_cur_bucket_0_without_preload_content(
        self,
        tenant_verify_cur_bucket_request: TenantVerifyCurBucketRequest,
        _request_timeout: Union[
            None,
    ...
    def _verify_tenant_cur_bucket_0_serialize(
        self,
        tenant_verify_cur_bucket_request,
        _request_auth,
        _content_type,
