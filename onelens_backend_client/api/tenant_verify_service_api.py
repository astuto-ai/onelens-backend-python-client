...
class TenantVerifyServiceApi:
    ...
    def verify_tenant(
        self,
        tenant_verify_request_with_user: TenantVerifyRequestWithUser,
        ...
        :param tenant_verify_request_with_user: (required)
        :type tenant_verify_request_with_user: TenantVerifyRequestWithUser
        ...
        _param = self._verify_tenant_serialize(
            tenant_verify_request_with_user=tenant_verify_request_with_user,
    ...
    def verify_tenant_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TenantVerifyResponse]:
        """Verify Tenant
    ...
    def _verify_tenant_serialize(
        self,
        tenant_verify_request_with_user,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if tenant_verify_request_with_user is not None:
            _body_params = tenant_verify_request_with_user
