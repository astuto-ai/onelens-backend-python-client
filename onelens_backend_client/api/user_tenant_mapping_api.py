...
class UserTenantMappingApi:
    ...
    def create_user_tenant_mapping(
        ...
        :param create_user_tenant_mapping_request: (required)
        :type create_user_tenant_mapping_request: CreateUserTenantMappingRequest
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ResponseCreateUserTenantMappingResponse",
    ...
    def create_user_tenant_mapping_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResponseCreateUserTenantMappingResponse]:
        """Create User Tenant Mapping
    ...
    def _create_user_tenant_mapping_serialize(
        ...
        if create_user_tenant_mapping_request is not None:
            _body_params = create_user_tenant_mapping_request
