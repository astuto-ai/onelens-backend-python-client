...
[**create_root_node_0**](RecommendationApi.md#create_root_node_0) | Create Root Node
[**get_recommendation_by_ticket_id**](RecommendationApi.md#get_recommendation_by_ticket_id) | Get Recommendation By Ticket Id
[**get_recommendation_by_ticket_id_0**](RecommendationApi.md#get_recommendation_by_ticket_id_0) | Get Recommendation By Ticket Id
...
# **create_root_node_0**
> ResponseRecommendationTicketResponse create_root_node_0(recommendation_ticket_api_request_input)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create Root Node
        api_response = api_instance.create_root_node_0(recommendation_ticket_api_request_input)
        print("The response of RecommendationApi->create_root_node_0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RecommendationApi->create_root_node_0: %s\n" % e)
```
...
> ResponseRecommendationTicketResponse get_recommendation_by_ticket_id(tenant_id, ticket_id)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Recommendation By Ticket Id
        api_response = api_instance.get_recommendation_by_ticket_id(tenant_id, ticket_id)
...
# **get_recommendation_by_ticket_id_0**
> ResponseRecommendationTicketResponse get_recommendation_by_ticket_id_0(ticket_id)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Recommendation By Ticket Id
        api_response = api_instance.get_recommendation_by_ticket_id_0(ticket_id)
        print("The response of RecommendationApi->get_recommendation_by_ticket_id_0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RecommendationApi->get_recommendation_by_ticket_id_0: %s\n" % e)
```
