...
[**get_tenant_policy_stats**](TenantPoliciesApi.md#get_tenant_policy_stats) | Get Tenant Policy Stats
...
> ResponseAddTenantPolicyExclusionsResponse add_tenant_policy_exclusions(tenant_policy_id, add_tenant_policy_exclusions_api_request)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Add Tenant Policy Exclusions
        api_response = api_instance.add_tenant_policy_exclusions(tenant_policy_id, add_tenant_policy_exclusions_api_request)
...
> ResponseDisableTenantPolicyResponse disable_tenant_policy(tenant_policy_id)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Disable Tenant Policy
        api_response = api_instance.disable_tenant_policy(tenant_policy_id)
...
# **enable_all_policies**
> ResponseEnableAllPoliciesResponse enable_all_policies()
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable All Policies
        api_response = api_instance.enable_all_policies()
...
> ResponseEnableTenantPolicyResponse enable_tenant_policy(tenant_policy_id)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Enable Tenant Policy
        api_response = api_instance.enable_tenant_policy(tenant_policy_id)
...
# **get_tenant_policies**
> ResponseGetTenantPoliciesResponse get_tenant_policies(get_tenant_policies_api_request)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Tenant Policies
        api_response = api_instance.get_tenant_policies(get_tenant_policies_api_request)
...
> ResponseGetTenantPoliciesWithSettingsResponse get_tenant_policies_with_settings(get_tenant_policies_with_settings_api_request)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Tenant Policies With Settings
        api_response = api_instance.get_tenant_policies_with_settings(get_tenant_policies_with_settings_api_request)
...
> ResponseGetTenantPolicyByIdResponse get_tenant_policy_by_id(tenant_policy_id)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Tenant Policy By Id
        api_response = api_instance.get_tenant_policy_by_id(tenant_policy_id)
...
> ResponseGetTenantPolicyWithSummaryRequest get_tenant_policy_by_id_with_recommendations(tenant_policy_id)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Tenant Policy By Id With Recommendations
        api_response = api_instance.get_tenant_policy_by_id_with_recommendations(tenant_policy_id)
...
> ResponseGetTenantPolicySettingsResponse get_tenant_policy_settings(get_tenant_policy_settings_api_request)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Tenant Policy Settings
        api_response = api_instance.get_tenant_policy_settings(get_tenant_policy_settings_api_request)
...
> ResponseGetTenantPolicyStatsResponse get_tenant_policy_stats(get_tenant_policy_stats_api_request)

Get Tenant Policy Stats

API to get all Tenant Policy Stats in Tenant DB
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = onelens_backend_client.TenantPoliciesApi(api_client)
    get_tenant_policy_stats_api_request = onelens_backend_client.GetTenantPolicyStatsAPIRequest() # GetTenantPolicyStatsAPIRequest | 

    try:
        # Get Tenant Policy Stats
        api_response = api_instance.get_tenant_policy_stats(get_tenant_policy_stats_api_request)
        print("The response of TenantPoliciesApi->get_tenant_policy_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling TenantPoliciesApi->get_tenant_policy_stats: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **get_tenant_policy_stats_api_request** | [**GetTenantPolicyStatsAPIRequest**](GetTenantPolicyStatsAPIRequest.md)|  | 

### Return type

[**ResponseGetTenantPolicyStatsResponse**](ResponseGetTenantPolicyStatsResponse.md)
...
> ResponseGetTenantPoliciesResponse override_tenant_policy_config(tenant_policy_id, override_tenant_policy_config_api_request)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Override Tenant Policy Config
        api_response = api_instance.override_tenant_policy_config(tenant_policy_id, override_tenant_policy_config_api_request)
...
> ResponseOverrideTenantPolicyExclusionsResponse override_tenant_policy_exclusions(tenant_policy_id, override_tenant_policy_exclusions_api_request)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Override Tenant Policy Exclusions
        api_response = api_instance.override_tenant_policy_exclusions(tenant_policy_id, override_tenant_policy_exclusions_api_request)
