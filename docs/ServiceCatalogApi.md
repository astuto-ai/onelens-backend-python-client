...
[**get_metrics_0**](ServiceCatalogApi.md#get_metrics_0) | Get Metrics
[**get_service_catalog**](ServiceCatalogApi.md#get_service_catalog) | Get Service Catalog
[**get_service_catalog_0**](ServiceCatalogApi.md#get_service_catalog_0) | Get Service Catalog


# **get_metrics**
> ResponseGetMetricsResponse get_metrics(tenant_id, get_metrics_api_request)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Metrics
        api_response = api_instance.get_metrics(tenant_id, get_metrics_api_request)
...
# **get_metrics_0**
> ResponseGetMetricsResponse get_metrics_0(get_metrics_api_request)
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Metrics
        api_response = api_instance.get_metrics_0(get_metrics_api_request)
        print("The response of ServiceCatalogApi->get_metrics_0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ServiceCatalogApi->get_metrics_0: %s\n" % e)
```
...
# **get_service_catalog_0**
> object get_service_catalog_0()
...
with onelens_backend_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Service Catalog
        api_response = api_instance.get_service_catalog_0()
        print("The response of ServiceCatalogApi->get_service_catalog_0:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ServiceCatalogApi->get_service_catalog_0: %s\n" % e)
```
