...
from onelens_backend_client_v2.models import UpdateTenantEmbedAppsLinksResponse
...
class TenantEmbedAppsLinksServiceRpcHandler:
    ...
    def create_tenant_embed_apps_links(
        self,
        request: CreateTenantEmbedAppsLinksRequest,
        ...
        _param = self._create_tenant_embed_apps_links_serialize(
            request=request,
    ...
    def _create_tenant_embed_apps_links_serialize(
        self,
        request: CreateTenantEmbedAppsLinksRequest,
        _request_auth,
        _content_type,
    ...
    def delete_tenant_embed_apps_links(
        self,
        request: GetTenantEmbedAppsLinksRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._delete_tenant_embed_apps_links_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _delete_tenant_embed_apps_links_serialize(
        self,
        request: GetTenantEmbedAppsLinksRequest,
        _request_auth,
        _content_type,
    ...
    def get_all_tenant_embed_apps_links(
        self,
        request: GetAllTenantEmbedAppsLinksRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_tenant_embed_apps_link_by_id(
        ...
        _param = self._get_tenant_embed_apps_link_by_id_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_tenant_embed_apps_link_by_id_serialize(
        self,
        request: GetTenantEmbedAppsLinksRequest,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def update_tenant_embed_apps_links(
        self,
        request: string,
        _request_timeout: Union[
            None,
        ...
        _param = self._update_tenant_embed_apps_links_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "UpdateTenantEmbedAppsLinksResponse",
            "422": "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
    ...
    def _update_tenant_embed_apps_links_serialize(
        self,
        request: string,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/rpc/tenant_embed_apps_links_service/update_tenant_embed_apps_links",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
