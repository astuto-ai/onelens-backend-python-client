...
class CostlensServiceRpcHandler:
    ...
    def create_tenant_account_daily_cost_bulk(
        self,
        request: CreateTenantAccountDailyCostBulkRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._create_tenant_account_daily_cost_bulk_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _create_tenant_account_daily_cost_bulk_serialize(
        self,
        request: CreateTenantAccountDailyCostBulkRequest,
        _request_auth,
        _content_type,
    ...
    def delete_tenant_account_daily_cost(
        self,
        request: DeleteTenantAccountDailyCostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._delete_tenant_account_daily_cost_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _delete_tenant_account_daily_cost_serialize(
        self,
        request: DeleteTenantAccountDailyCostRequest,
        _request_auth,
        _content_type,
    ...
    def get_agregatted_tenant_account_daily_costs(
        self,
        request: GetAgregattedTenantAccountDailyCostsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_agregatted_tenant_account_daily_costs_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_agregatted_tenant_account_daily_costs_serialize(
        self,
        request: GetAgregattedTenantAccountDailyCostsRequest,
        _request_auth,
        _content_type,
    ...
    def get_tenant_account_daily_cost(
        self,
        request: GetTenantAccountDailyCostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_tenant_account_daily_cost_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_tenant_account_daily_cost_serialize(
        self,
        request: GetTenantAccountDailyCostRequest,
        _request_auth,
        _content_type,
    ...
    def update_tenant_account_daily_cost(
        self,
        request: UpdateTenantAccountDailyCostRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_tenant_account_daily_cost_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _update_tenant_account_daily_cost_serialize(
        self,
        request: UpdateTenantAccountDailyCostRequest,
        _request_auth,
        _content_type,
