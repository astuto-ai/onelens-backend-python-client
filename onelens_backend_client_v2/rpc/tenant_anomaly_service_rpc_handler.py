...
class TenantAnomalyServiceRpcHandler:
    ...
    def disable_tenant_anomaly_setting(
        self,
        request: DisableTenantAnomalySettingsRequest,
    ...
    def enable_tenant_anomaly_setting(
        self,
        request: EnableTenantAnomalySettingsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_tenant_anomaly_settings(
        self,
        request: GetTenantAnomalySettingsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def override_tenant_anomaly_setting_config(
        self,
        request: OverrideTenantAnomalyConfigRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._override_tenant_anomaly_setting_config_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _override_tenant_anomaly_setting_config_serialize(
        self,
        request: OverrideTenantAnomalyConfigRequest,
        _request_auth,
        _content_type,
