...
class ResourceMappingServiceRpcHandler:
    ...
    def delete_mappings_by_node_ids(
        self,
        request: DeleteResourceHierarchyMappingsByNodeIdsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._delete_mappings_by_node_ids_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _delete_mappings_by_node_ids_serialize(
        self,
        request: DeleteResourceHierarchyMappingsByNodeIdsRequest,
        _request_auth,
        _content_type,
    ...
    def get_node_metrics(
        self,
        request: GetHierarchyNodeMetricsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_node_metrics_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_node_metrics_serialize(
        self,
        request: GetHierarchyNodeMetricsRequest,
        _request_auth,
        _content_type,
    ...
    def get_resource_ids_list_for_node_ids(
        self,
        request: GetResourceIdsListForNodeIdsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_resource_ids_list_for_node_ids_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_resource_ids_list_for_node_ids_serialize(
        self,
        request: GetResourceIdsListForNodeIdsRequest,
        _request_auth,
        _content_type,
