...
class TenantConnectionServiceRpcHandler:
    ...
    def create_tenant_connection(
        ...
        _param = self._create_tenant_connection_serialize(
            request=request,
    ...
    def _create_tenant_connection_serialize(
        self,
        request: CreateTenantConnectionRequest,
        _request_auth,
        _content_type,
    ...
    def get_all_tenant_connections(
        self,
        request: GetAllTenantConnectionsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_all_tenant_connections_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_all_tenant_connections_serialize(
        self,
        request: GetAllTenantConnectionsRequest,
        _request_auth,
        _content_type,
    ...
    def get_tenant_connection(
        self,
        request: GetTenantConnectionRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_tenant_connection_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_tenant_connection_serialize(
        self,
        request: GetTenantConnectionRequest,
        _request_auth,
        _content_type,
