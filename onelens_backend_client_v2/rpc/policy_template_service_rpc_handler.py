...
class PolicyTemplateServiceRpcHandler:
    ...
    def activate_policy_template(
        self,
        request: ActivatePolicyTemplateRequest,
    ...
    def deprecate_policy_template(
        self,
        request: DeprecatePolicyTemplateRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def get_policy_template_by_alias(
        self,
        request: GetPolicyTemplateByAliasRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_policy_template_by_alias_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_policy_template_by_alias_serialize(
        self,
        request: GetPolicyTemplateByAliasRequest,
        _request_auth,
        _content_type,
    ...
    def get_policy_template_by_id(
        self,
        request: GetPolicyTemplateByIDRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
