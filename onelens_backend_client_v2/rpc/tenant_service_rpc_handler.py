...
from onelens_backend_client_v2.models import RunTenantMigrationsRequest


from onelens_backend_client_v2.models import RunTenantMigrationsResponse
...
class TenantServiceRpcHandler:
    ...
    def run_tenant_migrations(
        self,
        request: RunTenantMigrationsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> RunTenantMigrationsResponse:
        """Runs migrations for a list of tenant databases.



        :param request: (required)
        :type request: RunTenantMigrationsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._run_tenant_migrations_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "RunTenantMigrationsResponse",
            "422": "HTTPValidationError",
        }
        response_data = self.api_client.call_api(
            *_param, _request_timeout=_request_timeout
    ...
    def _run_tenant_migrations_serialize(
        self,
        request: RunTenantMigrationsRequest,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/rpc/tenant_service/run_tenant_migrations",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
