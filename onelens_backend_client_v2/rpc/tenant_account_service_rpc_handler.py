...
class TenantAccountServiceRpcHandler:
    ...
    def fetch_accounts(
        ...
        _param = self._fetch_accounts_serialize(
            request=request,
    ...
    def get_account_details_with_memory_metrics(
        self,
        request: GetMemoryMetricsEnabledAccountDetailsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_account_details_with_memory_metrics_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_account_details_with_memory_metrics_serialize(
        self,
        request: GetMemoryMetricsEnabledAccountDetailsRequest,
        _request_auth,
        _content_type,
