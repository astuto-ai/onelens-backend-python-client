...
class ResourceCatalogServiceRpcHandler:
    ...
    def get_all(
        self,
        request: GetAllResourceCatalogsRequest,
    ...
    def get_by_ids(
        self,
        request: ResourceCatalogListRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_by_ids_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def get_resource_by_id_v2(
        ...
        _param = self._get_resource_by_id_v2_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_resource_by_id_v2_serialize(
        self,
        request: ResourceCatalogRequest,
        _request_auth,
        _content_type,
    ...
    def get_resource_catalog_cost_data_stats(
        self,
        request: GetResourceCatalogCostDataStatsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_resource_catalog_cost_data_stats_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_resource_catalog_cost_data_stats_serialize(
        self,
        request: GetResourceCatalogCostDataStatsRequest,
        _request_auth,
        _content_type,
    ...
    def get_resources_v2(
        self,
        request: GetAllResourceCatalogsRequestV2,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_resources_v2_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_resources_v2_serialize(
        self,
        request: GetAllResourceCatalogsRequestV2,
        _request_auth,
        _content_type,
    ...
    def get_s3_agent_metrics_data(
        self,
        request: GetS3AgentMetricsDataRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_s3_agent_metrics_data_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_s3_agent_metrics_data_serialize(
        self,
        request: GetS3AgentMetricsDataRequest,
        _request_auth,
        _content_type,
    ...
    def upsert_resource_catalog_cost_data(
        self,
        request: UpsertResourceCatalogCostDataRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
