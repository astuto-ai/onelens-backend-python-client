# NaviraEmbeddingServiceRpcHandler API
...
class NaviraEmbeddingServiceRpcHandler:
    ...
    def update_embeddings(
        ...
        :type request: UpdateEmbeddingsRequest
        ...
        _param = self._update_embeddings_serialize(
            request=request,
    ...
    def _update_embeddings_serialize(
        self,
        request: UpdateEmbeddingsRequest,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/rpc/navira_embedding_service/update_embeddings",
