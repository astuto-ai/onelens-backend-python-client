...
class RateOptimizationServiceRpcHandler:
    ...
    def get_commitment_metadata(
        self,
        request: GetCommitmentMetadataRequest,
        ...
        _param = self._get_commitment_metadata_serialize(
            request=request,
    ...
    def _get_commitment_metadata_serialize(
        self,
        request: GetCommitmentMetadataRequest,
        _request_auth,
        _content_type,
    ...
    def get_commitment_utilization(
        self,
        request: GetCommitmentUtilizationRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_commitment_utilization_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_commitment_utilization_serialize(
        self,
        request: GetCommitmentUtilizationRequest,
        _request_auth,
        _content_type,
    ...
    def get_rate_optimization_overview_data(
        self,
        request: RateOptimizationOverviewDataRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_rate_optimization_overview_data_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_rate_optimization_overview_data_serialize(
        self,
        request: RateOptimizationOverviewDataRequest,
        _request_auth,
        _content_type,
    ...
    def get_rate_optimization_overview_stats(
        self,
        request: RateOptimizationOverviewStatsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_rate_optimization_overview_stats_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_rate_optimization_overview_stats_serialize(
        self,
        request: RateOptimizationOverviewStatsRequest,
        _request_auth,
        _content_type,
    ...
    def get_rate_optimization_overview_stats_trend(
        ...
        _param = self._get_rate_optimization_overview_stats_trend_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_rate_optimization_overview_stats_trend_serialize(
        self,
        request: RateOptimizationOverviewStatsRequest,
        _request_auth,
        _content_type,
    ...
    def get_renewal_commitments_from_inventory(
        self,
        request: GetRenewalCommitmentsFromInventoryRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> GetRenewalCommitmentsFromInventoryResponse:
        """
        ...
        _param = self._get_renewal_commitments_from_inventory_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_renewal_commitments_from_inventory_serialize(
        self,
        request: GetRenewalCommitmentsFromInventoryRequest,
        _request_auth,
        _content_type,
    ...
    def get_renewal_commitments_stats_from_inventory(
        self,
        request: GetRenewalCommitmentsStatsFromInventoryRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_renewal_commitments_stats_from_inventory_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_renewal_commitments_stats_from_inventory_serialize(
        self,
        request: GetRenewalCommitmentsStatsFromInventoryRequest,
        _request_auth,
        _content_type,
    ...
    def get_reserved_instances_data(
        self,
        request: GetReservedInstancesDataRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_reserved_instances_data_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_reserved_instances_data_serialize(
        self,
        request: GetReservedInstancesDataRequest,
        _request_auth,
        _content_type,
    ...
    def get_savings_plans_data(
        self,
        request: GetSavingsPlansDataRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._get_savings_plans_data_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_savings_plans_data_serialize(
        self,
        request: GetSavingsPlansDataRequest,
        _request_auth,
        _content_type,
    ...
    def save_rate_optimization_inventory_for_account(
        self,
        request: SaveRateOptimizationInventoryRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._save_rate_optimization_inventory_for_account_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _save_rate_optimization_inventory_for_account_serialize(
        self,
        request: SaveRateOptimizationInventoryRequest,
        _request_auth,
        _content_type,
    ...
    def validate_savings_plan_inventory(
        self,
        request: ValidateSavingsPlanInventoryRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._validate_savings_plan_inventory_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _validate_savings_plan_inventory_serialize(
        self,
        request: ValidateSavingsPlanInventoryRequest,
        _request_auth,
        _content_type,
