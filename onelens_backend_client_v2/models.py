...
#   filename:  <stdin>
#   timestamp: 2025-01-07T20:14:37+00:00
...
class CURDataMetricsQueryInput(BaseModel):
    ...
    time_filter: OnelensModelsServiceInterfacesTenantDataCurServiceTimeDimensionInput
...
class CURDataMetricsQueryOutput(BaseModel):
    ...
    time_filter: OnelensModelsServiceInterfacesTenantDataCurServiceTimeDimensionOutput
    timezone: Optional[str] = Field("Asia/Kolkata", title="Timezone")
