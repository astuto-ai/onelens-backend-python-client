...
#   filename:  <stdin>
#   timestamp: 2025-01-17T11:09:23+00:00
...
class OnelensDomainMetricsControlUtilsEnumsMetricName(str, Enum):
...
class OnelensModelsServiceInterfacesDeltaEventsCommonsMetricName(str, Enum):
...
class APIEnableMetricsRequest(BaseModel):
    ...
    metric_name: OnelensDomainMetricsControlUtilsEnumsMetricName = Field(
...
class APIMetricsControlFilter(BaseModel):
    ...
    metric_name: Optional[OnelensDomainMetricsControlUtilsEnumsMetricName] = Field(
...
class DeltaEvents(BaseModel):
    ...
    metric_name: OnelensModelsServiceInterfacesDeltaEventsCommonsMetricName = Field(
...
class FeatureConfig(BaseModel):
    ...
    metric_name: Optional[OnelensDomainMetricsControlUtilsEnumsMetricName] = None
...
class GetDeltaEventsFilters(BaseModel):
    ...
    metric_names: Optional[
        List[OnelensModelsServiceInterfacesDeltaEventsCommonsMetricName]
    ] = Field(None, description="List of metric names to filter", title="Metric Names")
...
class GetTenantPolicyExclusionsAPIRequest(BaseModel):
    ...
    metric_names: Optional[List[OnelensDomainMetricsControlUtilsEnumsMetricName]] = (
        Field([], description="The list of metric names.", title="Metric Names")
    )
