...
#   filename:  <stdin>
#   timestamp: 2025-01-27T05:44:16+00:00
...
class RecommendedCostAnalysis(BaseModel):
    ...
    initial_transition_cost: float = Field(..., title="Initial Transition Cost")
    new_storage_cost: float = Field(..., title="New Storage Cost")
    net_potential_savings: float = Field(..., title="Net Potential Savings")
...
class ResourceDetails(BaseModel):
    ...
    service_display_name: str = Field(..., title="Service Display Name")
    ...
    crn: str = Field(..., title="Crn")
    title: str = Field(..., title="Title")
    provider: str = Field(..., title="Provider")
    status: str = Field(..., title="Status")
    tags: Dict[str, Any] = Field(..., title="Tags")
    additional_info: Dict[str, Any] = Field(..., title="Additional Info")
    lifecycle_policies: List[Dict[str, Any]] = Field(..., title="Lifecycle Policies")
    ...
    tagged_resource: bool = Field(..., title="Tagged Resource")
    resource_created_at: datetime = Field(..., title="Resource Created At")
    resource_updated_at: datetime = Field(..., title="Resource Updated At")
...
class CustomTicketRecommendation(BaseModel):
    title: str = Field(..., title="Title")
    potential_savings: str = Field(..., title="Potential Savings")
    effort: str = Field(..., title="Effort")
    lifecycle_policy: List[Dict[str, Any]] = Field(..., title="Lifecycle Policy")
    cost_analysis: RecommendedCostAnalysis
...
class TenantCustomTicketDetails(BaseModel):
    potential_cost_saving: float = Field(..., title="Potential Cost Saving")
    ticket_characterstics: Optional[Dict[str, Any]] = Field(
        ..., title="Ticket Characterstics"
    )
    thread_id: UUID = Field(..., title="Thread Id")
    custom_ticket_recommendations: List[CustomTicketRecommendation] = Field(
...
class GetTenantCustomTicketDetailsResponse(BaseModel):
    ...
    resource_details: Dict[str, ResourceDetails] = Field(..., title="Resource Details")
