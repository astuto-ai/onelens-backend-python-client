...
#   filename:  <stdin>
#   timestamp: 2025-01-31T07:44:21+00:00
...
class RecommendedCostAnalysis(BaseModel):
    ...
    monthly_retrieval_cost: float = Field(..., title="Monthly Retrieval Cost")
...
class StorageMetrics(BaseModel):
    ...
    avg_read_requests: float = Field(..., title="Avg Read Requests")
    avg_write_requests: float = Field(..., title="Avg Write Requests")
    avg_transition_requests: float = Field(..., title="Avg Transition Requests")
...
class CreateCustomTenantTicketRequestMixin(BaseModel):
    ...
    last_run_id: Optional[UUID4] = Field(
        "74649aa5-e5f2-40d1-880c-4e3462351105",
        description="Id of the last policy violation/anomaly run",
        title="Last Run Id",
    )
    last_run_at: Optional[datetime] = Field(
        "2025-01-31T13:13:41.424073",
        description="Datetime of the last policy violation/anomaly run",
        title="Last Run At",
    )
    first_run_at: Optional[datetime] = Field(
        "2025-01-31T13:13:41.424093",
        description="Datetime of the first policy violation/anomaly run",
        title="First Run At",
    )
    created_by: Optional[UUID4] = Field(
