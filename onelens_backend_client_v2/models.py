...
#   filename:  <stdin>
#   timestamp: 2025-11-19T09:15:20+00:00
...
class OnboardGCPTenantRequest(BaseModel):
    ...
    parent_id: Optional[UUID4] = Field(None, title='Parent Id')
...
class GetSinglePolicyTicketByPolicyIdResponse(BaseModel):
    ...
    violation_attributes_details: Optional[
        Dict[str, ViolationAttributesDetails]
    ] = Field(
        None,
        description='Details of the violation attributes',
        title='Violation Attributes Details',
...
class TenantTicketFilters(BaseModel):
    ...
    statuses: Optional[
        Union[List[PolicyTicketStatus], List[AnomalyTicketStatus]]
    ] = Field(
        [],
...
class GetTicketClosureEvidenceDataResponse(BaseModel):
    ...
    achieved_savings_evidence_data: Optional[
        List[AchievedSavingsEvidenceDataPoint]
    ] = Field(
        [],
...
class LogAgentRunRequest(BaseModel):
    ...
    time_range: Optional[
        OnelensModelsServiceInterfacesKubernetesCommonTimeRange
...
class CreateCustomTenantTicketRequestMixin(BaseModel):
    ...
    last_run_id: Optional[UUID4] = Field(
        '354270d8-ee86-42a1-8b8e-9867712a6e5e',
        description='Id of the last policy violation/anomaly run',
        title='Last Run Id',
    )
    last_run_at: Optional[datetime] = Field(
        '2025-11-19T08:59:58.859310',
        description='Datetime of the last policy violation/anomaly run',
        title='Last Run At',
    )
    first_run_at: Optional[datetime] = Field(
        '2025-11-19T08:59:58.859327',
        description='Datetime of the first policy violation/anomaly run',
        title='First Run At',
    )
    created_by: Optional[UUID4] = Field(
