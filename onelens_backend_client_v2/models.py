...
#   filename:  <stdin>
#   timestamp: 2024-10-24T07:22:59+00:00
...
class TenantTicketsStatsMetricsCategory(str, Enum):
    ROOT = "ROOT"
    BUSINESS_UNIT = "BUSINESS_UNIT"
    DEPARTMENT = "DEPARTMENT"
    DIVISION = "DIVISION"
...
class GroupByOption(BaseModel):
    ...
    value: Union[
        TenantTicketsStatsMetricsCategory, TenantTicketsStatsMetricsGroupBy
...
class SubGroupByOption(BaseModel):
    ...
    value: Union[
        TenantTicketsStatsMetricsCategory, TenantTicketsStatsMetricsSubGroupBy
    ] = Field(..., description="Value of the group", title="Value")
...
class CreateSavedViewAPIRequest(BaseModel):
    name: constr(min_length=3, max_length=30) = Field(
        ..., description="Name of the saved view", title="Name"
    )
