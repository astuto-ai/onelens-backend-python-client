...
#   filename:  <stdin>
#   timestamp: 2024-10-09T08:14:09+00:00
...
class GetUsersNodesCategories(BaseModel):
    ...
    ] = Field(..., description="List of node categories.", title="Categories")
...
class GetLeafNodesResponse(BaseModel):
    ...
    nodes: List[HierarchyNodeEntityDTOOutput] = Field(..., description="List of leaf nodes.")
...
class GetPolicyTicketsExportRequest(BaseModel):
    ...
    file_extension: Optional[ExportFileType] = Field(
        "csv", description="export file type"
    )
...
class ResourceHierarchyMappingRequest(BaseModel):
    ...
    leaf_nodes: GetLeafNodesResponseInput = Field(..., description="The leaf nodes")
