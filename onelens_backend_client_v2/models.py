...
class GetServiceAndResourceTypeResponse(BaseModel):
    ...
    is_metric_data_required: bool = Field(
        ...,
        description="Is the metric data required for this query",
        title="Is Metric Data Required",
    )
...
class GetSingleTenantTicketAuditResponse(BaseModel):
    ...
    old_record: Dict[str, Any] = Field(
        ..., description="The old record", title="Old Record"
    )
...
class MetricFeatureTheme(str, Enum):
    ...
    MEMORY_METRICS_NOT_ENABLED = "MEMORY_METRICS_NOT_ENABLED"
...
class ResourceCatalogExplorerRequest(BaseModel):
    query: str = Field(..., description="User query", title="Query")
    tenant_id: UUID4 = Field(
        ..., description="The id of the tenant.", title="Tenant Id"
    )
...
class ResourceCatalogExplorerResponse(BaseModel):
...
class SelectTablesRequest(BaseModel):
    query: str = Field(..., description="User query", title="Query")
    service: AwsService = Field(..., description="AWS service")
    resource_type: str = Field(..., description="Resource type", title="Resource Type")
    is_metric_data_required: bool = Field(
        ...,
        description="Is the metric data required for this query",
...
class MetricFeature(BaseModel):
    ...
    enabled: bool = Field(
        ..., description="Whether the metric is enabled", title="Enabled"
    )
    status: str = Field(..., description="Status of the metric", title="Status")
...
class GenerateSQLRequest(BaseModel):
    ...
    service: AwsService = Field(..., description="AWS service")
    resource_type: str = Field(..., description="Resource type", title="Resource Type")
    selected_tables: List[TableMetadata] = Field(
