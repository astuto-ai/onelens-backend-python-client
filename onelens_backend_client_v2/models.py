...
class AggregatedTicketsStatDetail(BaseModel):
    field_name: str = Field(..., title="Field Name")
    field_display_name: Optional[str] = Field(None, title="Field Display Name")
...
class BaseTableConfig(BaseModel):
    table: str = Field(
        ..., description="Table name to use as base table", title="Table"
    )
    alias: str = Field(..., description="Alias for the base table", title="Alias")
...
class DeleteAggregatedTicketsRequest(BaseModel):
    tenant_id: UUID = Field(
        ..., description="The unique identifier of the tenant", title="Tenant Id"
    )
...
class DeleteAggregatedTicketsResponse(BaseModel):
    pass
...
class GetAggregatedTicketsStatsResponse(BaseModel):
    ...
    details: List[AggregatedTicketsStatDetail] = Field(..., title="Details")
...
class GetAllRecommendationUnitsRequest(BaseModel):
    pass
...
class GetSpotMigrationStatsAPIRequest(BaseModel):
    cluster_id: UUID = Field(
...
class HierarchyNodeResourceFilters(BaseModel):
    source: Optional[str] = Field(
        None, description="Source of the resource filter", title="Source"
    )
    key: int = Field(..., title="Key")
    field: str = Field(..., title="Field")
    sub_field: Optional[str] = Field(None, title="Sub Field")
...
class JoinConfig(BaseModel):
    table: str = Field(..., description="Table name to join", title="Table")
    alias: str = Field(..., description="Table alias for the join", title="Alias")
    join_type: Optional[JoinType] = Field(
        "LEFT", description="Type of JOIN operation", title="Join Type"
    )
    on_condition: str = Field(
        ..., description="JOIN ON condition SQL", title="On Condition"
    )
...
class OnboardOpenAITenantResponse(BaseModel):
    message: str = Field(..., description="Message", title="Message")
    success: bool = Field(..., description="Success", title="Success")
    tenant_provider_id: UUID4 = Field(
        ..., description="Tenant Provider ID", title="Tenant Provider Id"
...
class OpenAIBillingConfig(BaseModel):
    api_key: str = Field(..., description="API Key", title="Api Key")
...
class PipelineRunStatus(str, Enum):
    ...
    INGESTION_UNSUPPORTED_PROVIDER = "INGESTION_UNSUPPORTED_PROVIDER"
    TRANSFORMATION_STARTED = "TRANSFORMATION_STARTED"
    TRANSFORMATION_FAILED = "TRANSFORMATION_FAILED"
    TRANSFORMATION_SUCCESS = "TRANSFORMATION_SUCCESS"
    TRANSFORMATION_UNSUPPORTED_PROVIDER = "TRANSFORMATION_UNSUPPORTED_PROVIDER"
...
class TicketSubtype(str, Enum):
    ...
    AZURE_MONITOR_INSIGHT_TICKET = "AZURE_MONITOR_INSIGHT_TICKET"
...
class RunTenantMigrationsRequest(BaseModel):
    tenant_ids: List[UUID4] = Field(
        ..., description="List of tenant ids", title="Tenant Ids"
    )


class RunTenantMigrationsResponse(BaseModel):
    pass
...
class SpotMigrationRiskStats(BaseModel):
    risk_level: SpotMigrationRisk = Field(..., description="Risk level category")
    workload_count: int = Field(
        ...,
        description="Number of workloads in this risk category",
        title="Workload Count",
    )
    total_cost: float = Field(
        ...,
        description="Total cost of workloads in this risk category",
        title="Total Cost",
    )
    potential_savings: float = Field(
        ...,
        description="Potential savings (60% of total_cost)",
        title="Potential Savings",
    )


class SpotMigrationWorkloadData(BaseModel):
    workload_name: str = Field(
        ..., description="Name of the workload", title="Workload Name"
    )
    namespace: str = Field(
    ...
    total_cost: float = Field(
        ..., description="Total cost of the workload", title="Total Cost"
    )
    potential_savings: float = Field(
        ...,
        description="Potential savings (60% of total_cost)",
    ...
    replicas: Optional[int] = Field(
        None, description="Number of replicas for the workload", title="Replicas"
    )
    risk_level: SpotMigrationRisk = Field(
        ..., description="Risk level for spot migration"
    )
    risk_tooltip: str = Field(
        ..., description="Explanation of the risk level", title="Risk Tooltip"
    )
...
class SubcategoryOutput(str, Enum):
...
class SyncTicketDataResponse(BaseModel):
    tickets_synced: bool = Field(
        ..., description="Whether the tickets were synced", title="Tickets Synced"
    )
    tickets_synced_count: int = Field(
        ..., description="The number of tickets synced", title="Tickets Synced Count"
    )
    tickets_not_synced_count: int = Field(
        ...,
        description="The number of tickets not synced",
        title="Tickets Not Synced Count",
    )
...
class TicketTypeOutput(str, Enum):
    SYSTEM = "SYSTEM"
    USER = "USER"
...
class UnsyncTicketDataRequest(BaseModel):
    ticket_ids: List[UUID] = Field(
        ..., description="The unique identifiers of the tickets", title="Ticket Ids"
    )
    policy_ids: List[UUID] = Field(
    ...
    batch_size: Optional[int] = Field(
        500, description="The batch size for unsyncing ticket data", title="Batch Size"
    )
    tenant_id: UUID4 = Field(
        ..., description="The unique identifier of the tenant", title="Tenant Id"
    )
...
class UnsyncTicketDataResponse(BaseModel):
    tickets_unsynced: bool = Field(
        ..., description="Whether the tickets were unsynced", title="Tickets Unsynced"
    )
    tickets_unsynced_count: int = Field(
        ...,
        description="The number of tickets unsynced",
        title="Tickets Unsynced Count",
    )
...
class OnelensModelsServiceInterfacesAggregatedViolationsCommonsTicketType(str, Enum):
    CUSTOM = "CUSTOM"
    POLICY = "POLICY"
    INSIGHTS = "INSIGHTS"
...
class OnelensModelsServiceInterfacesPoliciesCommonDtoSubcategory(str, Enum):
    RIGHTSIZING = "RIGHTSIZING"
    UNUSED_RESOURCES = "UNUSED_RESOURCES"
    LOW_COST_MIGRATIONS = "LOW_COST_MIGRATIONS"
    SCHEDULING = "SCHEDULING"
...
class OnelensModelsServiceInterfacesPoliciesCommonsSubcategory(str, Enum):
    RIGHTSIZING = "RIGHTSIZING"
    UNUSED_RESOURCES = "UNUSED_RESOURCES"
    LOW_COST_MIGRATIONS = "LOW_COST_MIGRATIONS"
    SCHEDULING = "SCHEDULING"
...
class OnelensModelsServiceInterfacesTicketsCommonsTicketType(str, Enum):
    SYSTEM = "SYSTEM"
    USER = "USER"
...
class AggregatedTicketsMixin(BaseModel):
    short_id: str = Field(
        ...,
        description="The short identifier of the aggregated ticket",
        title="Short Id",
    )
    ticket_ol_id: UUID = Field(
        ..., description="The unique identifier of the ticket", title="Ticket Ol Id"
    )
    resource_ol_id: Optional[UUID] = Field(
        None,
        description="The unique identifier of the resource",
        title="Resource Ol Id",
    )
    resource_id: Optional[str] = Field(
        None, description="The identifier of the resource", title="Resource Id"
    )
    resource_name: Optional[str] = Field(
        None, description="The name of the resource", title="Resource Name"
    )
    resource_title: Optional[str] = Field(
        None, description="The title of the resource", title="Resource Title"
    )
    status: PolicyTicketStatus = Field(..., description="The status of the ticket")
    policy_ol_id: Optional[UUID] = Field(
        None, description="The unique identifier of the policy", title="Policy Ol Id"
    )
    policy_id: Optional[str] = Field(
        None, description="The identifier of the policy", title="Policy Id"
    )
    policy_title: Optional[str] = Field(
        None, description="The title of the policy", title="Policy Title"
    )
    policy_label: Optional[PolicyCategory] = Field(
        None, description="The label/category of the policy"
    )
    ...
    suggested_recommendations: Optional[Dict[str, Any]] = Field(
        None,
        description="Suggested recommendations as JSONB",
        title="Suggested Recommendations",
    )
    recommendation_category: Optional[ChangeType] = Field(
        None, description="The category of the recommendation change type"
    )
    cost_saving_category: Optional[
        OnelensModelsServiceInterfacesPoliciesCommonsSubcategory
    ] = Field(None, description="The cost saving subcategory")
    effort: Optional[Effort] = Field(None, description="The effort required")
    risk: Optional[Risk] = Field(None, description="The risk level")
    priority: Optional[Priority] = Field(None, description="The priority level")
    account_name: Optional[str] = Field(
        None, description="The name of the account", title="Account Name"
    )
    account_id: str = Field(
        ..., description="The identifier of the account", title="Account Id"
    )
    region: str = Field(..., description="The region", title="Region")
    service: str = Field(..., description="The service", title="Service")
    evidence: Optional[Dict[str, Any]] = Field(
        None, description="Evidence as JSONB", title="Evidence"
    )
    monthly_potential_savings: float = Field(
        ...,
        description="Monthly potential savings amount",
        title="Monthly Potential Savings",
    )
    monthly_achieved_savings: Optional[float] = Field(
        None,
        description="Monthly achieved savings amount",
        title="Monthly Achieved Savings",
    )
    objective: Optional[str] = Field(
        None, description="The objective", title="Objective"
    )
    impact_on_performance: Optional[str] = Field(
        None, description="Impact on performance", title="Impact On Performance"
    )
    downtime_required: Optional[str] = Field(
        None, description="Downtime required information", title="Downtime Required"
    )
    compatibility_issues: Optional[str] = Field(
        None,
        description="Compatibility issues information",
        title="Compatibility Issues",
    )
    last_sync_date: datetime = Field(
        ..., description="Last synchronization date", title="Last Sync Date"
    )
    created_date: Optional[datetime] = Field(
        None, description="Date when the ticket was created", title="Created Date"
    )
    closure_date: Optional[datetime] = Field(
        None, description="Date when the ticket was closed", title="Closure Date"
    )
    resource_acted_on: Optional[datetime] = Field(
        None, description="Date when resource was acted upon", title="Resource Acted On"
    )
    ticket_type: OnelensModelsServiceInterfacesAggregatedViolationsCommonsTicketType = (
        Field(..., description="The type of the ticket")
    )
    cloud_provider: Provider = Field(..., description="The cloud provider")
    creator_ol_id: UUID = Field(
        ..., description="The unique identifier of the creator", title="Creator Ol Id"
    )
    creator_name: Optional[str] = Field(
        None, description="The name of the creator", title="Creator Name"
    )
    creator_email: Optional[str] = Field(
        None, description="The email of the creator", title="Creator Email"
    )
    assigned_to: Optional[str] = Field(
        None, description="The person assigned to", title="Assigned To"
    )
    assigned_to_email: Optional[str] = Field(
        None,
        description="The email of the person assigned to",
...
class CustomTicketRecommendationInput(BaseModel):
    title: str = Field(..., title="Title")
    potential_savings: float = Field(
        ...,
    ...
    cost_saving_category: OnelensModelsServiceInterfacesPoliciesCommonDtoSubcategory = (
        Field(..., description="The category of cost savings")
    )
...
class CustomTicketRecommendationOutput(BaseModel):
    title: str = Field(..., title="Title")
    potential_savings: float = Field(
        ...,
        description="The potential savings of the recommendation",
    ...
    cost_saving_category: SubcategoryOutput = Field(
...
class GetAllRecommendationUnitsResponse(BaseModel):
...
class GetSinglePolicyTicketByPolicyIdResponse(BaseModel):
    ...
    ticket_type: Optional[TicketTypeOutput] = Field(None, description="Ticket type")
    objective: Optional[str] = Field(None, description="Objective", title="Objective")
    ticket_owner: Optional[str] = Field(
        None, description="Ticket owner", title="Ticket Owner"
    )
...
class GetSpotMigrationStatsResponse(BaseModel):
    stats: List[SpotMigrationRiskStats] = Field(
        ..., description="Stats breakdown by risk level", title="Stats"
    )
    total_workload_count: int = Field(
        ...,
        description="Total number of workloads analyzed",
        title="Total Workload Count",
    )
    total_cost: float = Field(
        ..., description="Total cost across all workloads", title="Total Cost"
    )
...
class GetWorkloadsV3Response(BaseModel):
    pagination: Optional[PaginationFields] = Field(
        None, description="Pagination metadata for the response"
    )
    workloads: List[SpotMigrationWorkloadData] = Field(
        ...,
        description="List of workloads with spot migration risk data",
        title="Workloads",
    )
...
class OnboardOpenAITenantRequest(BaseModel):
    ...
    organization_id: str = Field(
        ..., description="Organization ID", title="Organization Id"
    )
    billing_config: Optional[OpenAIBillingConfig] = None
...
class TenantPolicyFilters(BaseModel):
    ...
    cost_saving_categories: Optional[
        List[OnelensModelsServiceInterfacesPoliciesCommonDtoSubcategory]
    ] = Field(
        [],
...
class DataRequest(BaseModel):
    ...
    joins: Optional[List[JoinConfig]] = Field(
        None, description="Table join configurations", title="Joins"
    )
    base_table: Optional[BaseTableConfig] = Field(
        None,
        description="Override the base table from config. If provided, this table will be used in FROM clause instead of the config's sql_table",
    )
...
class GetAggregatedTicketsRequest(BaseModel):
    pagination: Optional[PaginationParams] = Field(
        {"page": 1, "page_size": 10},
        description="Pagination parameters for the request.",
    )
...
class GetAggregatedTicketsStatsAPIRequest(BaseModel):
    stat_name: str = Field(..., title="Stat Name")
    filters: Optional[
        List[OnelensDomainUtilitiesRepositoriesDynamicFiltersFilterCriteria]
    ] = Field(None, title="Filters")
...
class GetAggregatedTicketsStatsRequest(BaseModel):
    stat_name: str = Field(..., title="Stat Name")
    filters: Optional[
        List[OnelensDomainUtilitiesRepositoriesDynamicFiltersFilterCriteria]
    ] = Field(None, title="Filters")
...
class GetClusterCostBreakdownRequest(BaseModel):
    ...
    filters: Optional[
        ...
        None, description="Optional filter criteria for CCBA filtering", title="Filters"
    )
...
class GetWorkloadsV3APIRequest(BaseModel):
    filters: Optional[
        List[OnelensDomainUtilitiesRepositoriesDynamicFiltersFilterCriteria]
    ] = Field(
        None,
...
class TenantCustomTicketDetailsInput(BaseModel):
    ...
    custom_ticket_recommendations: Optional[List[CustomTicketRecommendationInput]] = (
        Field(
            None,
...
class TenantCustomTicketDetailsOutput(BaseModel):
    ...
    custom_ticket_recommendations: Optional[List[CustomTicketRecommendationOutput]] = (
        Field(
            None,
            description="Custom ticket recommendations",
            title="Custom Ticket Recommendations",
...
class TenantTicketWithTicketAlias(BaseModel):
    ...
    ticket_type: Optional[TicketTypeOutput] = Field(
...
class CreateCustomTenantTicketRequestMixin(BaseModel):
    ...
    ticket_type: Optional[OnelensModelsServiceInterfacesTicketsCommonsTicketType] = (
        Field("SYSTEM", description="Type of the ticket")
    )
    priority: Optional[Priority] = Field("LOW", description="Priority of the ticket")
    ticket_owner: Optional[UUID] = Field(
        None, description="Owner of the ticket", title="Ticket Owner"
...
class UpdateTenantTicketsAPIRequest(BaseModel):
    ...
    sync_data: Optional[bool] = Field(
        True,
        description="Whether to sync ticket data to aggregated tickets after update",
        title="Sync Data",
    )
    send_notification: Optional[bool] = Field(
        True,
...
class SyncAzureMonitorTicketsRequest(BaseModel):
    tenant_id: UUID = Field(..., title="Tenant Id")
    tickets: Optional[List[AggregatedTicketsMixin]] = Field(None, title="Tickets")
    created_ticket_ol_ids: Optional[List[UUID]] = Field(
        None, title="Created Ticket Ol Ids"
...
class SyncAzureMonitorTicketsResponse(BaseModel):
    tickets_written: Optional[int] = Field(0, title="Tickets Written")
    history_entries_written: Optional[int] = Field(
        0, title="History Entries Written"
    )
...
class BulkUpdateAzureMonitorTicketsRequest(BaseModel):
    tenant_id: UUID = Field(..., title="Tenant Id")
    ticket_ids: List[UUID] = Field(..., title="Ticket Ids")
    status: Optional[PolicyTicketStatus] = None
    priority: Optional[Priority] = None
...
class BulkUpdateAzureMonitorTicketsResponse(BaseModel):
    successful_ticket_ids: Optional[List[UUID]] = Field(
        None, title="Successful Ticket Ids"
    )
    failed_ticket_ids: Optional[List[UUID]] = Field(None, title="Failed Ticket Ids")
