...
#   filename:  <stdin>
#   timestamp: 2025-04-17T12:01:22+00:00
...
class DetectChangeResponseV2(BaseModel):
    changed_from: Optional[str] = Field(
        None, description="Original value before change", title="Changed From"
    )
    changed_to: Optional[str] = Field(
...
class GetDeltaEventsStatsResponse(BaseModel):
    total_events: int = Field(
        ..., description="Total number of delta events", title="Total Events"
    )
...
class GetPresignedUrlForCustomTicketAPIRequest(BaseModel):
    file_name: str = Field(..., description="Name of the file", title="File Name")
    type: CustomTicketPresignedUrlType = Field(
        ..., description="Type of request: Download, Upload, Delete"
    )
    file_key: Optional[str] = Field(
        None,
        description="File key to be used for the presigned URL. When downloading or deleting, this is required.",
        title="File Key",
    )
...
class GetPresignedUrlForCustomTicketResponse(BaseModel):
    presigned_url: str = Field(..., description="Presigned URL", title="Presigned Url")
    file_key: str = Field(..., description="File key", title="File Key")
    expires_in: int = Field(..., description="Expires in", title="Expires In")
...
class ResourceInformation(BaseModel):
    ...
    resource_file: Optional[str] = Field(
        None, description="Resource file S3 Link", title="Resource File"
    )
...
class GetDeltaEventsForWorkflowAPIRequest(BaseModel):
    ...
    filters: Optional[GetDeltaEventsFilters] = Field(
        None, description="Additional filters for delta events"
    )
...
class GetDeltaEventsRequest(BaseModel):
    ...
    filters: Optional[GetDeltaEventsFilters] = Field(
        None, description="Filters for delta events"
    )
    tenant_id: UUID = Field(..., description="ID of the tenant", title="Tenant Id")
...
class GetDeltaEventsStatsRequest(BaseModel):
    filters: Optional[GetDeltaEventsFilters] = Field(
        None, description="Filters for delta events stats"
    )
...
class TenantCustomTicketDetailsInput(BaseModel):
    ...
    achieved_savings: Optional[float] = Field(
        None, description="Achieved savings for the ticket", title="Achieved Savings"
    )
    account_id: Optional[str] = Field(
    ...
    reason_of_change: Optional[constr(max_length=500)] = Field(
        None, description="Reason of change", title="Reason Of Change"
    )
    recommendation: Optional[constr(max_length=100)] = Field(
    ...
    usage_information: Optional[constr(max_length=50)] = Field(
...
class CreateCustomTenantTicketRequestMixin(BaseModel):
    ...
    last_run_id: Optional[UUID4] = Field(
        "4feb4fae-38c3-4c88-a403-6640555d6d5b",
        description="Id of the last policy violation/anomaly run",
        title="Last Run Id",
    )
    last_run_at: Optional[datetime] = Field(
        "2025-04-17T17:13:42.475317",
        description="Datetime of the last policy violation/anomaly run",
        title="Last Run At",
    )
    first_run_at: Optional[datetime] = Field(
        "2025-04-17T17:13:42.475333",
        description="Datetime of the first policy violation/anomaly run",
        title="First Run At",
    )
    created_by: Optional[UUID4] = Field(
...
class DataRequest(BaseModel):
    ...
    dimensions: List[str] = Field(
        ..., description="Dimensions to group by", title="Dimensions"
    )
    filters: Optional[
    ...
    order: Optional[List[SortCriteria]] = Field(
        None, description="Result ordering configuration", title="Order"
    )
...
class GetWorkloadsAPIRequest(BaseModel):
    ...
    filters: Optional[
        List[OnelensDomainUtilitiesRepositoriesDynamicFiltersFilterCriteria]
    ] = Field(None, description="Workload filters", title="Filters")
...
class GetWorkloadsResponse(BaseModel):
    ...
    groups: Optional[List[WorkloadGroup]] = Field(
        None,
        description="Grouped workload data when grouping is requested",
        title="Groups",
    )
