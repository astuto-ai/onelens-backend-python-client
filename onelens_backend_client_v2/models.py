...
#   filename:  <stdin>
#   timestamp: 2024-09-02T11:29:25+00:00
...
class Auth0UserConnection(Enum):
...
class CurDataAggregationType(Enum):
...
class GetResourceCatalogStatsResponse(BaseModel):
...
class HierarchyNodeCategory(Enum):
    ROOT = "ROOT"
    BUSINESS_UNIT = "BUSINESS_UNIT"
    DEPARTMENT = "DEPARTMENT"
    DIVISION = "DIVISION"
...
class HierarchyNodeResourceMetrics(BaseModel):
    total: int = Field(
        ..., description="The total count of the resource.", title="Total"
    )
...
class HierarchySharedNodeStrategy(Enum):
    EQUAL = "EQUAL"
...
class PolicyInputsModel(BaseModel):
    current: Optional[List[str]] = Field(
        [],
        description="list of current value source_key attributes with value_type as _input",
        title="Current",
    )
    target: Optional[List[str]] = Field(
        [],
        description="list of target value source_key attributes with value_type as _input",
        title="Target",
    )
...
class RecommendationQueryDetails(BaseModel):
    derived_variables: Optional[List[QueryDetailsDerivedVariables]] = Field(
...
class RecommendationUnitResponse(BaseModel):
    ...
    policy_inputs: Optional[PolicyInputsModel] = Field(
        [], description="list of policy inputs"
    )
...
class ResponseGetResourceCatalogStatsResponse(BaseModel):
    data: GetResourceCatalogStatsResponse
    message: Optional[str] = Field(None, title="Message")
...
class TenantEmbedAppsLinkState(Enum):
    ACTIVE = "ACTIVE"
    DELETED = "DELETED"
...
class OnelensModelsServiceInterfacesTenantDataCurServiceGranularity(Enum):
    days = "days"


class OnelensModelsServiceInterfacesTenantDataCurServiceOperator(Enum):
    equals = "equals"
...
class FilterCriteriaOutput(BaseModel):
    field: str = Field(..., title="Field")
...
class GetAllResourceCatalogsResponse(BaseModel):
    pagination: PaginationFields = Field(..., description="Pagination fields.")
    resources: List[ResourceCatalog] = Field(
...
class GetRecommendationUnitByIdResponse(BaseModel):
    recommendation_unit: RecommendationUnitResponse = Field(
...
class OnelensModelsServiceInterfacesTenantDataMetricsServiceFilterCriteriaInput(
    BaseModel
):
    field: str = Field(..., title="Field")
...
class GetCurDataAPIRequest(BaseModel):
    query: CURDataQuery
...
class GetResourceCatalogStatsRequest(BaseModel):
    filters: List[OnelensDomainUtilitiesRepositoriesDynamicFiltersFilterCriteria] = (
        Field(..., description="Filters to be applied", title="Filters")
    )
    navira_log_id: Optional[UUID4] = Field(
...
class MetricsQueryOutput(BaseModel):
    ...
    metric_name: str = Field(..., title="Metric Name")
    measures: List[MetricsAggregationType] = Field(..., title="Measures")
    filters: List[FilterCriteriaOutput] = Field(..., title="Filters")
    time_filter: (
